(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function o(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(i){if(i.ep)return;i.ep=!0;const s=o(i);fetch(i.href,s)}})();window.Vaadin=window.Vaadin||{};window.Vaadin.featureFlags=window.Vaadin.featureFlags||{};window.Vaadin.featureFlags.exampleFeatureFlag=!1;window.Vaadin.featureFlags.collaborationEngineBackend=!1;window.Vaadin.featureFlags.sideNavComponent=!0;const Li="modulepreload",Mi=function(t,e){return new URL(t,e).href},Zo={},x=function(e,o,n){if(!o||o.length===0)return e();const i=document.getElementsByTagName("link");return Promise.all(o.map(s=>{if(s=Mi(s,n),s in Zo)return;Zo[s]=!0;const r=s.endsWith(".css"),l=r?'[rel="stylesheet"]':"";if(!!n)for(let c=i.length-1;c>=0;c--){const m=i[c];if(m.href===s&&(!r||m.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${s}"]${l}`))return;const d=document.createElement("link");if(d.rel=r?"stylesheet":Li,r||(d.as="script",d.crossOrigin=""),d.href=s,document.head.appendChild(d),r)return new Promise((c,m)=>{d.addEventListener("load",c),d.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${s}`)))})})).then(()=>e())};function bt(t){return t=t||[],Array.isArray(t)?t:[t]}function Y(t){return`[Vaadin.Router] ${t}`}function Vi(t){if(typeof t!="object")return String(t);const e=Object.prototype.toString.call(t).match(/ (.*)\]$/)[1];return e==="Object"||e==="Array"?`${e} ${JSON.stringify(t)}`:e}const _t="module",wt="nomodule",_o=[_t,wt];function en(t){if(!t.match(/.+\.[m]?js$/))throw new Error(Y(`Unsupported type for bundle "${t}": .js or .mjs expected.`))}function Jn(t){if(!t||!K(t.path))throw new Error(Y('Expected route config to be an object with a "path" string property, or an array of such objects'));const e=t.bundle,o=["component","redirect","bundle"];if(!ge(t.action)&&!Array.isArray(t.children)&&!ge(t.children)&&!St(e)&&!o.some(n=>K(t[n])))throw new Error(Y(`Expected route config "${t.path}" to include either "${o.join('", "')}" or "action" function but none found.`));if(e)if(K(e))en(e);else if(_o.some(n=>n in e))_o.forEach(n=>n in e&&en(e[n]));else throw new Error(Y('Expected route bundle to include either "'+wt+'" or "'+_t+'" keys, or both'));t.redirect&&["bundle","component"].forEach(n=>{n in t&&console.warn(Y(`Route config "${t.path}" has both "redirect" and "${n}" properties, and "redirect" will always override the latter. Did you mean to only use "${n}"?`))})}function tn(t){bt(t).forEach(e=>Jn(e))}function on(t,e){let o=document.head.querySelector('script[src="'+t+'"][async]');return o||(o=document.createElement("script"),o.setAttribute("src",t),e===_t?o.setAttribute("type",_t):e===wt&&o.setAttribute(wt,""),o.async=!0),new Promise((n,i)=>{o.onreadystatechange=o.onload=s=>{o.__dynamicImportLoaded=!0,n(s)},o.onerror=s=>{o.parentNode&&o.parentNode.removeChild(o),i(s)},o.parentNode===null?document.head.appendChild(o):o.__dynamicImportLoaded&&n()})}function Di(t){return K(t)?on(t):Promise.race(_o.filter(e=>e in t).map(e=>on(t[e],e)))}function Fe(t,e){return!window.dispatchEvent(new CustomEvent(`vaadin-router-${t}`,{cancelable:t==="go",detail:e}))}function St(t){return typeof t=="object"&&!!t}function ge(t){return typeof t=="function"}function K(t){return typeof t=="string"}function Xn(t){const e=new Error(Y(`Page not found (${t.pathname})`));return e.context=t,e.code=404,e}const Pe=new class{};function zi(t){const e=t.port,o=t.protocol,s=o==="http:"&&e==="80"||o==="https:"&&e==="443"?t.hostname:t.host;return`${o}//${s}`}function nn(t){if(t.defaultPrevented||t.button!==0||t.shiftKey||t.ctrlKey||t.altKey||t.metaKey)return;let e=t.target;const o=t.composedPath?t.composedPath():t.path||[];for(let l=0;l<o.length;l++){const a=o[l];if(a.nodeName&&a.nodeName.toLowerCase()==="a"){e=a;break}}for(;e&&e.nodeName.toLowerCase()!=="a";)e=e.parentNode;if(!e||e.nodeName.toLowerCase()!=="a"||e.target&&e.target.toLowerCase()!=="_self"||e.hasAttribute("download")||e.hasAttribute("router-ignore")||e.pathname===window.location.pathname&&e.hash!==""||(e.origin||zi(e))!==window.location.origin)return;const{pathname:i,search:s,hash:r}=e;Fe("go",{pathname:i,search:s,hash:r})&&(t.preventDefault(),t&&t.type==="click"&&window.scrollTo(0,0))}const Ui={activate(){window.document.addEventListener("click",nn)},inactivate(){window.document.removeEventListener("click",nn)}},ji=/Trident/.test(navigator.userAgent);ji&&!ge(window.PopStateEvent)&&(window.PopStateEvent=function(t,e){e=e||{};var o=document.createEvent("Event");return o.initEvent(t,!!e.bubbles,!!e.cancelable),o.state=e.state||null,o},window.PopStateEvent.prototype=window.Event.prototype);function sn(t){if(t.state==="vaadin-router-ignore")return;const{pathname:e,search:o,hash:n}=window.location;Fe("go",{pathname:e,search:o,hash:n})}const Fi={activate(){window.addEventListener("popstate",sn)},inactivate(){window.removeEventListener("popstate",sn)}};var De=ni,Bi=No,Hi=Ki,qi=ei,Wi=oi,Qn="/",Zn="./",Gi=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function No(t,e){for(var o=[],n=0,i=0,s="",r=e&&e.delimiter||Qn,l=e&&e.delimiters||Zn,a=!1,d;(d=Gi.exec(t))!==null;){var c=d[0],m=d[1],h=d.index;if(s+=t.slice(i,h),i=h+c.length,m){s+=m[1],a=!0;continue}var f="",se=t[i],re=d[2],te=d[3],zt=d[4],B=d[5];if(!a&&s.length){var X=s.length-1;l.indexOf(s[X])>-1&&(f=s[X],s=s.slice(0,X))}s&&(o.push(s),s="",a=!1);var Se=f!==""&&se!==void 0&&se!==f,xe=B==="+"||B==="*",Ut=B==="?"||B==="*",oe=f||r,nt=te||zt;o.push({name:re||n++,prefix:f,delimiter:oe,optional:Ut,repeat:xe,partial:Se,pattern:nt?Yi(nt):"[^"+ae(oe)+"]+?"})}return(s||i<t.length)&&o.push(s+t.substr(i)),o}function Ki(t,e){return ei(No(t,e))}function ei(t){for(var e=new Array(t.length),o=0;o<t.length;o++)typeof t[o]=="object"&&(e[o]=new RegExp("^(?:"+t[o].pattern+")$"));return function(n,i){for(var s="",r=i&&i.encode||encodeURIComponent,l=0;l<t.length;l++){var a=t[l];if(typeof a=="string"){s+=a;continue}var d=n?n[a.name]:void 0,c;if(Array.isArray(d)){if(!a.repeat)throw new TypeError('Expected "'+a.name+'" to not repeat, but got array');if(d.length===0){if(a.optional)continue;throw new TypeError('Expected "'+a.name+'" to not be empty')}for(var m=0;m<d.length;m++){if(c=r(d[m],a),!e[l].test(c))throw new TypeError('Expected all "'+a.name+'" to match "'+a.pattern+'"');s+=(m===0?a.prefix:a.delimiter)+c}continue}if(typeof d=="string"||typeof d=="number"||typeof d=="boolean"){if(c=r(String(d),a),!e[l].test(c))throw new TypeError('Expected "'+a.name+'" to match "'+a.pattern+'", but got "'+c+'"');s+=a.prefix+c;continue}if(a.optional){a.partial&&(s+=a.prefix);continue}throw new TypeError('Expected "'+a.name+'" to be '+(a.repeat?"an array":"a string"))}return s}}function ae(t){return t.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function Yi(t){return t.replace(/([=!:$/()])/g,"\\$1")}function ti(t){return t&&t.sensitive?"":"i"}function Ji(t,e){if(!e)return t;var o=t.source.match(/\((?!\?)/g);if(o)for(var n=0;n<o.length;n++)e.push({name:n,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,pattern:null});return t}function Xi(t,e,o){for(var n=[],i=0;i<t.length;i++)n.push(ni(t[i],e,o).source);return new RegExp("(?:"+n.join("|")+")",ti(o))}function Qi(t,e,o){return oi(No(t,o),e,o)}function oi(t,e,o){o=o||{};for(var n=o.strict,i=o.start!==!1,s=o.end!==!1,r=ae(o.delimiter||Qn),l=o.delimiters||Zn,a=[].concat(o.endsWith||[]).map(ae).concat("$").join("|"),d=i?"^":"",c=t.length===0,m=0;m<t.length;m++){var h=t[m];if(typeof h=="string")d+=ae(h),c=m===t.length-1&&l.indexOf(h[h.length-1])>-1;else{var f=h.repeat?"(?:"+h.pattern+")(?:"+ae(h.delimiter)+"(?:"+h.pattern+"))*":h.pattern;e&&e.push(h),h.optional?h.partial?d+=ae(h.prefix)+"("+f+")?":d+="(?:"+ae(h.prefix)+"("+f+"))?":d+=ae(h.prefix)+"("+f+")"}}return s?(n||(d+="(?:"+r+")?"),d+=a==="$"?"$":"(?="+a+")"):(n||(d+="(?:"+r+"(?="+a+"))?"),c||(d+="(?="+r+"|"+a+")")),new RegExp(d,ti(o))}function ni(t,e,o){return t instanceof RegExp?Ji(t,e):Array.isArray(t)?Xi(t,e,o):Qi(t,e,o)}De.parse=Bi;De.compile=Hi;De.tokensToFunction=qi;De.tokensToRegExp=Wi;const{hasOwnProperty:Zi}=Object.prototype,wo=new Map;wo.set("|false",{keys:[],pattern:/(?:)/});function rn(t){try{return decodeURIComponent(t)}catch{return t}}function es(t,e,o,n,i){o=!!o;const s=`${t}|${o}`;let r=wo.get(s);if(!r){const d=[];r={keys:d,pattern:De(t,d,{end:o,strict:t===""})},wo.set(s,r)}const l=r.pattern.exec(e);if(!l)return null;const a=Object.assign({},i);for(let d=1;d<l.length;d++){const c=r.keys[d-1],m=c.name,h=l[d];(h!==void 0||!Zi.call(a,m))&&(c.repeat?a[m]=h?h.split(c.delimiter).map(rn):[]:a[m]=h&&rn(h))}return{path:l[0],keys:(n||[]).concat(r.keys),params:a}}function ii(t,e,o,n,i){let s,r,l=0,a=t.path||"";return a.charAt(0)==="/"&&(o&&(a=a.substr(1)),o=!0),{next(d){if(t===d)return{done:!0};const c=t.__children=t.__children||t.children;if(!s&&(s=es(a,e,!c,n,i),s))return{done:!1,value:{route:t,keys:s.keys,params:s.params,path:s.path}};if(s&&c)for(;l<c.length;){if(!r){const h=c[l];h.parent=t;let f=s.path.length;f>0&&e.charAt(f)==="/"&&(f+=1),r=ii(h,e.substr(f),o,s.keys,s.params)}const m=r.next(d);if(!m.done)return{done:!1,value:m.value};r=null,l++}return{done:!0}}}}function ts(t){if(ge(t.route.action))return t.route.action(t)}function os(t,e){let o=e;for(;o;)if(o=o.parent,o===t)return!0;return!1}function ns(t){let e=`Path '${t.pathname}' is not properly resolved due to an error.`;const o=(t.route||{}).path;return o&&(e+=` Resolution had failed on route: '${o}'`),e}function is(t,e){const{route:o,path:n}=e;if(o&&!o.__synthetic){const i={path:n,route:o};if(!t.chain)t.chain=[];else if(o.parent){let s=t.chain.length;for(;s--&&t.chain[s].route&&t.chain[s].route!==o.parent;)t.chain.pop()}t.chain.push(i)}}class He{constructor(e,o={}){if(Object(e)!==e)throw new TypeError("Invalid routes");this.baseUrl=o.baseUrl||"",this.errorHandler=o.errorHandler,this.resolveRoute=o.resolveRoute||ts,this.context=Object.assign({resolver:this},o.context),this.root=Array.isArray(e)?{path:"",__children:e,parent:null,__synthetic:!0}:e,this.root.parent=null}getRoutes(){return[...this.root.__children]}setRoutes(e){tn(e);const o=[...bt(e)];this.root.__children=o}addRoutes(e){return tn(e),this.root.__children.push(...bt(e)),this.getRoutes()}removeRoutes(){this.setRoutes([])}resolve(e){const o=Object.assign({},this.context,K(e)?{pathname:e}:e),n=ii(this.root,this.__normalizePathname(o.pathname),this.baseUrl),i=this.resolveRoute;let s=null,r=null,l=o;function a(d,c=s.value.route,m){const h=m===null&&s.value.route;return s=r||n.next(h),r=null,!d&&(s.done||!os(c,s.value.route))?(r=s,Promise.resolve(Pe)):s.done?Promise.reject(Xn(o)):(l=Object.assign(l?{chain:l.chain?l.chain.slice(0):[]}:{},o,s.value),is(l,s.value),Promise.resolve(i(l)).then(f=>f!=null&&f!==Pe?(l.result=f.result||f,l):a(d,c,f)))}return o.next=a,Promise.resolve().then(()=>a(!0,this.root)).catch(d=>{const c=ns(l);if(d?console.warn(c):d=new Error(c),d.context=d.context||l,d instanceof DOMException||(d.code=d.code||500),this.errorHandler)return l.result=this.errorHandler(d),l;throw d})}static __createUrl(e,o){return new URL(e,o)}get __effectiveBaseUrl(){return this.baseUrl?this.constructor.__createUrl(this.baseUrl,document.baseURI||document.URL).href.replace(/[^\/]*$/,""):""}__normalizePathname(e){if(!this.baseUrl)return e;const o=this.__effectiveBaseUrl,n=this.constructor.__createUrl(e,o).href;if(n.slice(0,o.length)===o)return n.slice(o.length)}}He.pathToRegexp=De;const{pathToRegexp:an}=He,ln=new Map;function si(t,e,o){const n=e.name||e.component;if(n&&(t.has(n)?t.get(n).push(e):t.set(n,[e])),Array.isArray(o))for(let i=0;i<o.length;i++){const s=o[i];s.parent=e,si(t,s,s.__children||s.children)}}function dn(t,e){const o=t.get(e);if(o&&o.length>1)throw new Error(`Duplicate route with name "${e}". Try seting unique 'name' route properties.`);return o&&o[0]}function cn(t){let e=t.path;return e=Array.isArray(e)?e[0]:e,e!==void 0?e:""}function ss(t,e={}){if(!(t instanceof He))throw new TypeError("An instance of Resolver is expected");const o=new Map;return(n,i)=>{let s=dn(o,n);if(!s&&(o.clear(),si(o,t.root,t.root.__children),s=dn(o,n),!s))throw new Error(`Route "${n}" not found`);let r=ln.get(s.fullPath);if(!r){let a=cn(s),d=s.parent;for(;d;){const f=cn(d);f&&(a=f.replace(/\/$/,"")+"/"+a.replace(/^\//,"")),d=d.parent}const c=an.parse(a),m=an.tokensToFunction(c),h=Object.create(null);for(let f=0;f<c.length;f++)K(c[f])||(h[c[f].name]=!0);r={toPath:m,keys:h},ln.set(a,r),s.fullPath=a}let l=r.toPath(i,e)||"/";if(e.stringifyQueryParams&&i){const a={},d=Object.keys(i);for(let m=0;m<d.length;m++){const h=d[m];r.keys[h]||(a[h]=i[h])}const c=e.stringifyQueryParams(a);c&&(l+=c.charAt(0)==="?"?c:`?${c}`)}return l}}let hn=[];function rs(t){hn.forEach(e=>e.inactivate()),t.forEach(e=>e.activate()),hn=t}const as=t=>{const e=getComputedStyle(t).getPropertyValue("animation-name");return e&&e!=="none"},ls=(t,e)=>{const o=()=>{t.removeEventListener("animationend",o),e()};t.addEventListener("animationend",o)};function un(t,e){return t.classList.add(e),new Promise(o=>{if(as(t)){const n=t.getBoundingClientRect(),i=`height: ${n.bottom-n.top}px; width: ${n.right-n.left}px`;t.setAttribute("style",`position: absolute; ${i}`),ls(t,()=>{t.classList.remove(e),t.removeAttribute("style"),o()})}else t.classList.remove(e),o()})}const ds=256;function Ht(t){return t!=null}function cs(t){const e=Object.assign({},t);return delete e.next,e}function W({pathname:t="",search:e="",hash:o="",chain:n=[],params:i={},redirectFrom:s,resolver:r},l){const a=n.map(d=>d.route);return{baseUrl:r&&r.baseUrl||"",pathname:t,search:e,hash:o,routes:a,route:l||a.length&&a[a.length-1]||null,params:i,redirectFrom:s,getUrl:(d={})=>mt(le.pathToRegexp.compile(ri(a))(Object.assign({},i,d)),r)}}function pn(t,e){const o=Object.assign({},t.params);return{redirect:{pathname:e,from:t.pathname,params:o}}}function hs(t,e){e.location=W(t);const o=t.chain.map(n=>n.route).indexOf(t.route);return t.chain[o].element=e,e}function pt(t,e,o){if(ge(t))return t.apply(o,e)}function mn(t,e,o){return n=>{if(n&&(n.cancel||n.redirect))return n;if(o)return pt(o[t],e,o)}}function us(t,e){if(!Array.isArray(t)&&!St(t))throw new Error(Y(`Incorrect "children" value for the route ${e.path}: expected array or object, but got ${t}`));e.__children=[];const o=bt(t);for(let n=0;n<o.length;n++)Jn(o[n]),e.__children.push(o[n])}function lt(t){if(t&&t.length){const e=t[0].parentNode;for(let o=0;o<t.length;o++)e.removeChild(t[o])}}function mt(t,e){const o=e.__effectiveBaseUrl;return o?e.constructor.__createUrl(t.replace(/^\//,""),o).pathname:t}function ri(t){return t.map(e=>e.path).reduce((e,o)=>o.length?e.replace(/\/$/,"")+"/"+o.replace(/^\//,""):e,"")}class le extends He{constructor(e,o){const n=document.head.querySelector("base"),i=n&&n.getAttribute("href");super([],Object.assign({baseUrl:i&&He.__createUrl(i,document.URL).pathname.replace(/[^\/]*$/,"")},o)),this.resolveRoute=r=>this.__resolveRoute(r);const s=le.NavigationTrigger;le.setTriggers.apply(le,Object.keys(s).map(r=>s[r])),this.baseUrl,this.ready,this.ready=Promise.resolve(e),this.location,this.location=W({resolver:this}),this.__lastStartedRenderId=0,this.__navigationEventHandler=this.__onNavigationEvent.bind(this),this.setOutlet(e),this.subscribe(),this.__createdByRouter=new WeakMap,this.__addedByRouter=new WeakMap}__resolveRoute(e){const o=e.route;let n=Promise.resolve();ge(o.children)&&(n=n.then(()=>o.children(cs(e))).then(s=>{!Ht(s)&&!ge(o.children)&&(s=o.children),us(s,o)}));const i={redirect:s=>pn(e,s),component:s=>{const r=document.createElement(s);return this.__createdByRouter.set(r,!0),r}};return n.then(()=>{if(this.__isLatestRender(e))return pt(o.action,[e,i],o)}).then(s=>{if(Ht(s)&&(s instanceof HTMLElement||s.redirect||s===Pe))return s;if(K(o.redirect))return i.redirect(o.redirect);if(o.bundle)return Di(o.bundle).then(()=>{},()=>{throw new Error(Y(`Bundle not found: ${o.bundle}. Check if the file name is correct`))})}).then(s=>{if(Ht(s))return s;if(K(o.component))return i.component(o.component)})}setOutlet(e){e&&this.__ensureOutlet(e),this.__outlet=e}getOutlet(){return this.__outlet}setRoutes(e,o=!1){return this.__previousContext=void 0,this.__urlForName=void 0,super.setRoutes(e),o||this.__onNavigationEvent(),this.ready}render(e,o){const n=++this.__lastStartedRenderId,i=Object.assign({search:"",hash:""},K(e)?{pathname:e}:e,{__renderId:n});return this.ready=this.resolve(i).then(s=>this.__fullyResolveChain(s)).then(s=>{if(this.__isLatestRender(s)){const r=this.__previousContext;if(s===r)return this.__updateBrowserHistory(r,!0),this.location;if(this.location=W(s),o&&this.__updateBrowserHistory(s,n===1),Fe("location-changed",{router:this,location:this.location}),s.__skipAttach)return this.__copyUnchangedElements(s,r),this.__previousContext=s,this.location;this.__addAppearingContent(s,r);const l=this.__animateIfNeeded(s);return this.__runOnAfterEnterCallbacks(s),this.__runOnAfterLeaveCallbacks(s,r),l.then(()=>{if(this.__isLatestRender(s))return this.__removeDisappearingContent(),this.__previousContext=s,this.location})}}).catch(s=>{if(n===this.__lastStartedRenderId)throw o&&this.__updateBrowserHistory(i),lt(this.__outlet&&this.__outlet.children),this.location=W(Object.assign(i,{resolver:this})),Fe("error",Object.assign({router:this,error:s},i)),s}),this.ready}__fullyResolveChain(e,o=e){return this.__findComponentContextAfterAllRedirects(o).then(n=>{const s=n!==o?n:e,l=mt(ri(n.chain),n.resolver)===n.pathname,a=(d,c=d.route,m)=>d.next(void 0,c,m).then(h=>h===null||h===Pe?l?d:c.parent!==null?a(d,c.parent,h):h:h);return a(n).then(d=>{if(d===null||d===Pe)throw Xn(s);return d&&d!==Pe&&d!==n?this.__fullyResolveChain(s,d):this.__amendWithOnBeforeCallbacks(n)})})}__findComponentContextAfterAllRedirects(e){const o=e.result;return o instanceof HTMLElement?(hs(e,o),Promise.resolve(e)):o.redirect?this.__redirect(o.redirect,e.__redirectCount,e.__renderId).then(n=>this.__findComponentContextAfterAllRedirects(n)):o instanceof Error?Promise.reject(o):Promise.reject(new Error(Y(`Invalid route resolution result for path "${e.pathname}". Expected redirect object or HTML element, but got: "${Vi(o)}". Double check the action return value for the route.`)))}__amendWithOnBeforeCallbacks(e){return this.__runOnBeforeCallbacks(e).then(o=>o===this.__previousContext||o===e?o:this.__fullyResolveChain(o))}__runOnBeforeCallbacks(e){const o=this.__previousContext||{},n=o.chain||[],i=e.chain;let s=Promise.resolve();const r=()=>({cancel:!0}),l=a=>pn(e,a);if(e.__divergedChainIndex=0,e.__skipAttach=!1,n.length){for(let a=0;a<Math.min(n.length,i.length)&&!(n[a].route!==i[a].route||n[a].path!==i[a].path&&n[a].element!==i[a].element||!this.__isReusableElement(n[a].element,i[a].element));a=++e.__divergedChainIndex);if(e.__skipAttach=i.length===n.length&&e.__divergedChainIndex==i.length&&this.__isReusableElement(e.result,o.result),e.__skipAttach){for(let a=i.length-1;a>=0;a--)s=this.__runOnBeforeLeaveCallbacks(s,e,{prevent:r},n[a]);for(let a=0;a<i.length;a++)s=this.__runOnBeforeEnterCallbacks(s,e,{prevent:r,redirect:l},i[a]),n[a].element.location=W(e,n[a].route)}else for(let a=n.length-1;a>=e.__divergedChainIndex;a--)s=this.__runOnBeforeLeaveCallbacks(s,e,{prevent:r},n[a])}if(!e.__skipAttach)for(let a=0;a<i.length;a++)a<e.__divergedChainIndex?a<n.length&&n[a].element&&(n[a].element.location=W(e,n[a].route)):(s=this.__runOnBeforeEnterCallbacks(s,e,{prevent:r,redirect:l},i[a]),i[a].element&&(i[a].element.location=W(e,i[a].route)));return s.then(a=>{if(a){if(a.cancel)return this.__previousContext.__renderId=e.__renderId,this.__previousContext;if(a.redirect)return this.__redirect(a.redirect,e.__redirectCount,e.__renderId)}return e})}__runOnBeforeLeaveCallbacks(e,o,n,i){const s=W(o);return e.then(r=>{if(this.__isLatestRender(o))return mn("onBeforeLeave",[s,n,this],i.element)(r)}).then(r=>{if(!(r||{}).redirect)return r})}__runOnBeforeEnterCallbacks(e,o,n,i){const s=W(o,i.route);return e.then(r=>{if(this.__isLatestRender(o))return mn("onBeforeEnter",[s,n,this],i.element)(r)})}__isReusableElement(e,o){return e&&o?this.__createdByRouter.get(e)&&this.__createdByRouter.get(o)?e.localName===o.localName:e===o:!1}__isLatestRender(e){return e.__renderId===this.__lastStartedRenderId}__redirect(e,o,n){if(o>ds)throw new Error(Y(`Too many redirects when rendering ${e.from}`));return this.resolve({pathname:this.urlForPath(e.pathname,e.params),redirectFrom:e.from,__redirectCount:(o||0)+1,__renderId:n})}__ensureOutlet(e=this.__outlet){if(!(e instanceof Node))throw new TypeError(Y(`Expected router outlet to be a valid DOM Node (but got ${e})`))}__updateBrowserHistory({pathname:e,search:o="",hash:n=""},i){if(window.location.pathname!==e||window.location.search!==o||window.location.hash!==n){const s=i?"replaceState":"pushState";window.history[s](null,document.title,e+o+n),window.dispatchEvent(new PopStateEvent("popstate",{state:"vaadin-router-ignore"}))}}__copyUnchangedElements(e,o){let n=this.__outlet;for(let i=0;i<e.__divergedChainIndex;i++){const s=o&&o.chain[i].element;if(s)if(s.parentNode===n)e.chain[i].element=s,n=s;else break}return n}__addAppearingContent(e,o){this.__ensureOutlet(),this.__removeAppearingContent();const n=this.__copyUnchangedElements(e,o);this.__appearingContent=[],this.__disappearingContent=Array.from(n.children).filter(s=>this.__addedByRouter.get(s)&&s!==e.result);let i=n;for(let s=e.__divergedChainIndex;s<e.chain.length;s++){const r=e.chain[s].element;r&&(i.appendChild(r),this.__addedByRouter.set(r,!0),i===n&&this.__appearingContent.push(r),i=r)}}__removeDisappearingContent(){this.__disappearingContent&&lt(this.__disappearingContent),this.__disappearingContent=null,this.__appearingContent=null}__removeAppearingContent(){this.__disappearingContent&&this.__appearingContent&&(lt(this.__appearingContent),this.__disappearingContent=null,this.__appearingContent=null)}__runOnAfterLeaveCallbacks(e,o){if(o)for(let n=o.chain.length-1;n>=e.__divergedChainIndex&&this.__isLatestRender(e);n--){const i=o.chain[n].element;if(i)try{const s=W(e);pt(i.onAfterLeave,[s,{},o.resolver],i)}finally{this.__disappearingContent.indexOf(i)>-1&&lt(i.children)}}}__runOnAfterEnterCallbacks(e){for(let o=e.__divergedChainIndex;o<e.chain.length&&this.__isLatestRender(e);o++){const n=e.chain[o].element||{},i=W(e,e.chain[o].route);pt(n.onAfterEnter,[i,{},e.resolver],n)}}__animateIfNeeded(e){const o=(this.__disappearingContent||[])[0],n=(this.__appearingContent||[])[0],i=[],s=e.chain;let r;for(let l=s.length;l>0;l--)if(s[l-1].route.animate){r=s[l-1].route.animate;break}if(o&&n&&r){const l=St(r)&&r.leave||"leaving",a=St(r)&&r.enter||"entering";i.push(un(o,l)),i.push(un(n,a))}return Promise.all(i).then(()=>e)}subscribe(){window.addEventListener("vaadin-router-go",this.__navigationEventHandler)}unsubscribe(){window.removeEventListener("vaadin-router-go",this.__navigationEventHandler)}__onNavigationEvent(e){const{pathname:o,search:n,hash:i}=e?e.detail:window.location;K(this.__normalizePathname(o))&&(e&&e.preventDefault&&e.preventDefault(),this.render({pathname:o,search:n,hash:i},!0))}static setTriggers(...e){rs(e)}urlForName(e,o){return this.__urlForName||(this.__urlForName=ss(this)),mt(this.__urlForName(e,o),this)}urlForPath(e,o){return mt(le.pathToRegexp.compile(e)(o),this)}static go(e){const{pathname:o,search:n,hash:i}=K(e)?this.__createUrl(e,"http://a"):e;return Fe("go",{pathname:o,search:n,hash:i})}}const ps=/\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,ft=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function ms(){function t(){return!0}return ai(t)}function fs(){try{return vs()?!0:gs()?ft?!ys():!ms():!1}catch{return!1}}function vs(){return localStorage.getItem("vaadin.developmentmode.force")}function gs(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function ys(){return!!(ft&&Object.keys(ft).map(e=>ft[e]).filter(e=>e.productionMode).length>0)}function ai(t,e){if(typeof t!="function")return;const o=ps.exec(t.toString());if(o)try{t=new Function(o[1])}catch(n){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",n)}return t(e)}window.Vaadin=window.Vaadin||{};const fn=function(t,e){if(window.Vaadin.developmentMode)return ai(t,e)};window.Vaadin.developmentMode===void 0&&(window.Vaadin.developmentMode=fs());function bs(){}const _s=function(){if(typeof fn=="function")return fn(bs)};window.Vaadin=window.Vaadin||{};window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.registrations.push({is:"@vaadin/router",version:"1.7.4"});_s();le.NavigationTrigger={POPSTATE:Fi,CLICK:Ui};var qt,$;(function(t){t.CONNECTED="connected",t.LOADING="loading",t.RECONNECTING="reconnecting",t.CONNECTION_LOST="connection-lost"})($||($={}));class ws{constructor(e){this.stateChangeListeners=new Set,this.loadingCount=0,this.connectionState=e,this.serviceWorkerMessageListener=this.serviceWorkerMessageListener.bind(this),navigator.serviceWorker&&(navigator.serviceWorker.addEventListener("message",this.serviceWorkerMessageListener),navigator.serviceWorker.ready.then(o=>{var n;(n=o==null?void 0:o.active)===null||n===void 0||n.postMessage({method:"Vaadin.ServiceWorker.isConnectionLost",id:"Vaadin.ServiceWorker.isConnectionLost"})}))}addStateChangeListener(e){this.stateChangeListeners.add(e)}removeStateChangeListener(e){this.stateChangeListeners.delete(e)}loadingStarted(){this.state=$.LOADING,this.loadingCount+=1}loadingFinished(){this.decreaseLoadingCount($.CONNECTED)}loadingFailed(){this.decreaseLoadingCount($.CONNECTION_LOST)}decreaseLoadingCount(e){this.loadingCount>0&&(this.loadingCount-=1,this.loadingCount===0&&(this.state=e))}get state(){return this.connectionState}set state(e){if(e!==this.connectionState){const o=this.connectionState;this.connectionState=e,this.loadingCount=0;for(const n of this.stateChangeListeners)n(o,this.connectionState)}}get online(){return this.connectionState===$.CONNECTED||this.connectionState===$.LOADING}get offline(){return!this.online}serviceWorkerMessageListener(e){typeof e.data=="object"&&e.data.id==="Vaadin.ServiceWorker.isConnectionLost"&&(e.data.result===!0&&(this.state=$.CONNECTION_LOST),navigator.serviceWorker.removeEventListener("message",this.serviceWorkerMessageListener))}}const Ss=t=>!!(t==="localhost"||t==="[::1]"||t.match(/^127\.\d+\.\d+\.\d+$/)),dt=window;if(!(!((qt=dt.Vaadin)===null||qt===void 0)&&qt.connectionState)){let t;Ss(window.location.hostname)?t=!0:t=navigator.onLine,dt.Vaadin=dt.Vaadin||{},dt.Vaadin.connectionState=new ws(t?$.CONNECTED:$.CONNECTION_LOST)}function j(t,e,o,n){var i=arguments.length,s=i<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,o):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(t,e,o,n);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(s=(i<3?r(s):i>3?r(e,o,s):r(e,o))||s);return i>3&&s&&Object.defineProperty(e,o,s),s}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xs=!1,vt=window,Po=vt.ShadowRoot&&(vt.ShadyCSS===void 0||vt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ao=Symbol(),vn=new WeakMap;class Io{constructor(e,o,n){if(this._$cssResult$=!0,n!==Ao)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this._strings=o}get styleSheet(){let e=this._styleSheet;const o=this._strings;if(Po&&e===void 0){const n=o!==void 0&&o.length===1;n&&(e=vn.get(o)),e===void 0&&((this._styleSheet=e=new CSSStyleSheet).replaceSync(this.cssText),n&&vn.set(o,e))}return e}toString(){return this.cssText}}const Es=t=>{if(t._$cssResult$===!0)return t.cssText;if(typeof t=="number")return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},li=t=>new Io(typeof t=="string"?t:String(t),void 0,Ao),E=(t,...e)=>{const o=t.length===1?t[0]:e.reduce((n,i,s)=>n+Es(i)+t[s+1],t[0]);return new Io(o,t,Ao)},Cs=(t,e)=>{Po?t.adoptedStyleSheets=e.map(o=>o instanceof CSSStyleSheet?o:o.styleSheet):e.forEach(o=>{const n=document.createElement("style"),i=vt.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=o.cssText,t.appendChild(n)})},ks=t=>{let e="";for(const o of t.cssRules)e+=o.cssText;return li(e)},gn=Po||xs?t=>t:t=>t instanceof CSSStyleSheet?ks(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Wt,Gt,Kt,di;const Z=window;let ci,de;const yn=Z.trustedTypes,$s=yn?yn.emptyScript:"",gt=Z.reactiveElementPolyfillSupportDevMode;{const t=(Wt=Z.litIssuedWarnings)!==null&&Wt!==void 0?Wt:Z.litIssuedWarnings=new Set;de=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))},de("dev-mode","Lit is in dev mode. Not recommended for production!"),!((Gt=Z.ShadyDOM)===null||Gt===void 0)&&Gt.inUse&&gt===void 0&&de("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded."),ci=e=>({then:(o,n)=>{de("request-update-promise",`The \`requestUpdate\` method should no longer return a Promise but does so on \`${e}\`. Use \`updateComplete\` instead.`),o!==void 0&&o(!1)}})}const Yt=t=>{Z.emitLitDebugLogEvents&&Z.dispatchEvent(new CustomEvent("lit-debug",{detail:t}))},hi=(t,e)=>t,So={toAttribute(t,e){switch(e){case Boolean:t=t?$s:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t);break}return t},fromAttribute(t,e){let o=t;switch(e){case Boolean:o=t!==null;break;case Number:o=t===null?null:Number(t);break;case Object:case Array:try{o=JSON.parse(t)}catch{o=null}break}return o}},ui=(t,e)=>e!==t&&(e===e||t===t),Jt={attribute:!0,type:String,converter:So,reflect:!1,hasChanged:ui},xo="finalized";class ee extends HTMLElement{constructor(){super(),this.__instanceProperties=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this._initialize()}static addInitializer(e){var o;this.finalize(),((o=this._initializers)!==null&&o!==void 0?o:this._initializers=[]).push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((o,n)=>{const i=this.__attributeNameForProperty(n,o);i!==void 0&&(this.__attributeToPropertyMap.set(i,n),e.push(i))}),e}static createProperty(e,o=Jt){var n;if(o.state&&(o.attribute=!1),this.finalize(),this.elementProperties.set(e,o),!o.noAccessor&&!this.prototype.hasOwnProperty(e)){const i=typeof e=="symbol"?Symbol():`__${e}`,s=this.getPropertyDescriptor(e,i,o);s!==void 0&&(Object.defineProperty(this.prototype,e,s),this.hasOwnProperty("__reactivePropertyKeys")||(this.__reactivePropertyKeys=new Set((n=this.__reactivePropertyKeys)!==null&&n!==void 0?n:[])),this.__reactivePropertyKeys.add(e))}}static getPropertyDescriptor(e,o,n){return{get(){return this[o]},set(i){const s=this[e];this[o]=i,this.requestUpdate(e,s,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Jt}static finalize(){if(this.hasOwnProperty(xo))return!1;this[xo]=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),e._initializers!==void 0&&(this._initializers=[...e._initializers]),this.elementProperties=new Map(e.elementProperties),this.__attributeToPropertyMap=new Map,this.hasOwnProperty(hi("properties"))){const o=this.properties,n=[...Object.getOwnPropertyNames(o),...Object.getOwnPropertySymbols(o)];for(const i of n)this.createProperty(i,o[i])}this.elementStyles=this.finalizeStyles(this.styles);{const o=(n,i=!1)=>{this.prototype.hasOwnProperty(n)&&de(i?"renamed-api":"removed-api",`\`${n}\` is implemented on class ${this.name}. It has been ${i?"renamed":"removed"} in this version of LitElement.`)};o("initialize"),o("requestUpdateInternal"),o("_getUpdateComplete",!0)}return!0}static finalizeStyles(e){const o=[];if(Array.isArray(e)){const n=new Set(e.flat(1/0).reverse());for(const i of n)o.unshift(gn(i))}else e!==void 0&&o.push(gn(e));return o}static __attributeNameForProperty(e,o){const n=o.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}_initialize(){var e;this.__updatePromise=new Promise(o=>this.enableUpdating=o),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),(e=this.constructor._initializers)===null||e===void 0||e.forEach(o=>o(this))}addController(e){var o,n;((o=this.__controllers)!==null&&o!==void 0?o:this.__controllers=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((n=e.hostConnected)===null||n===void 0||n.call(e))}removeController(e){var o;(o=this.__controllers)===null||o===void 0||o.splice(this.__controllers.indexOf(e)>>>0,1)}__saveInstanceProperties(){this.constructor.elementProperties.forEach((e,o)=>{this.hasOwnProperty(o)&&(this.__instanceProperties.set(o,this[o]),delete this[o])})}createRenderRoot(){var e;const o=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return Cs(o,this.constructor.elementStyles),o}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this.__controllers)===null||e===void 0||e.forEach(o=>{var n;return(n=o.hostConnected)===null||n===void 0?void 0:n.call(o)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this.__controllers)===null||e===void 0||e.forEach(o=>{var n;return(n=o.hostDisconnected)===null||n===void 0?void 0:n.call(o)})}attributeChangedCallback(e,o,n){this._$attributeToProperty(e,n)}__propertyToAttribute(e,o,n=Jt){var i;const s=this.constructor.__attributeNameForProperty(e,n);if(s!==void 0&&n.reflect===!0){const l=(((i=n.converter)===null||i===void 0?void 0:i.toAttribute)!==void 0?n.converter:So).toAttribute(o,n.type);this.constructor.enabledWarnings.indexOf("migration")>=0&&l===void 0&&de("undefined-attribute-value",`The attribute value for the ${e} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`),this.__reflectingProperty=e,l==null?this.removeAttribute(s):this.setAttribute(s,l),this.__reflectingProperty=null}}_$attributeToProperty(e,o){var n;const i=this.constructor,s=i.__attributeToPropertyMap.get(e);if(s!==void 0&&this.__reflectingProperty!==s){const r=i.getPropertyOptions(s),l=typeof r.converter=="function"?{fromAttribute:r.converter}:((n=r.converter)===null||n===void 0?void 0:n.fromAttribute)!==void 0?r.converter:So;this.__reflectingProperty=s,this[s]=l.fromAttribute(o,r.type),this.__reflectingProperty=null}}requestUpdate(e,o,n){let i=!0;return e!==void 0&&(n=n||this.constructor.getPropertyOptions(e),(n.hasChanged||ui)(this[e],o)?(this._$changedProperties.has(e)||this._$changedProperties.set(e,o),n.reflect===!0&&this.__reflectingProperty!==e&&(this.__reflectingProperties===void 0&&(this.__reflectingProperties=new Map),this.__reflectingProperties.set(e,n))):i=!1),!this.isUpdatePending&&i&&(this.__updatePromise=this.__enqueueUpdate()),ci(this.localName)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(o){Promise.reject(o)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e,o;if(!this.isUpdatePending)return;if(Yt==null||Yt({kind:"update"}),!this.hasUpdated){const s=[];if((e=this.constructor.__reactivePropertyKeys)===null||e===void 0||e.forEach(r=>{var l;this.hasOwnProperty(r)&&!(!((l=this.__instanceProperties)===null||l===void 0)&&l.has(r))&&s.push(r)}),s.length)throw new Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${s.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}this.__instanceProperties&&(this.__instanceProperties.forEach((s,r)=>this[r]=s),this.__instanceProperties=void 0);let n=!1;const i=this._$changedProperties;try{n=this.shouldUpdate(i),n?(this.willUpdate(i),(o=this.__controllers)===null||o===void 0||o.forEach(s=>{var r;return(r=s.hostUpdate)===null||r===void 0?void 0:r.call(s)}),this.update(i)):this.__markUpdated()}catch(s){throw n=!1,this.__markUpdated(),s}n&&this._$didUpdate(i)}willUpdate(e){}_$didUpdate(e){var o;(o=this.__controllers)===null||o===void 0||o.forEach(n=>{var i;return(i=n.hostUpdated)===null||i===void 0?void 0:i.call(n)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e),this.isUpdatePending&&this.constructor.enabledWarnings.indexOf("change-in-update")>=0&&de("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(e){return!0}update(e){this.__reflectingProperties!==void 0&&(this.__reflectingProperties.forEach((o,n)=>this.__propertyToAttribute(n,this[n],o)),this.__reflectingProperties=void 0),this.__markUpdated()}updated(e){}firstUpdated(e){}}di=xo;ee[di]=!0;ee.elementProperties=new Map;ee.elementStyles=[];ee.shadowRootOptions={mode:"open"};gt==null||gt({ReactiveElement:ee});{ee.enabledWarnings=["change-in-update"];const t=function(e){e.hasOwnProperty(hi("enabledWarnings"))||(e.enabledWarnings=e.enabledWarnings.slice())};ee.enableWarning=function(e){t(this),this.enabledWarnings.indexOf(e)<0&&this.enabledWarnings.push(e)},ee.disableWarning=function(e){t(this);const o=this.enabledWarnings.indexOf(e);o>=0&&this.enabledWarnings.splice(o,1)}}((Kt=Z.reactiveElementVersions)!==null&&Kt!==void 0?Kt:Z.reactiveElementVersions=[]).push("1.6.2");Z.reactiveElementVersions.length>1&&de("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Xt,Qt,Zt,eo;const U=window,g=t=>{U.emitLitDebugLogEvents&&U.dispatchEvent(new CustomEvent("lit-debug",{detail:t}))};let Ts=0,xt;(Xt=U.litIssuedWarnings)!==null&&Xt!==void 0||(U.litIssuedWarnings=new Set),xt=(t,e)=>{e+=t?` See https://lit.dev/msg/${t} for more information.`:"",U.litIssuedWarnings.has(e)||(console.warn(e),U.litIssuedWarnings.add(e))},xt("dev-mode","Lit is in dev mode. Not recommended for production!");const H=!((Qt=U.ShadyDOM)===null||Qt===void 0)&&Qt.inUse&&((Zt=U.ShadyDOM)===null||Zt===void 0?void 0:Zt.noPatch)===!0?U.ShadyDOM.wrap:t=>t,Re=U.trustedTypes,bn=Re?Re.createPolicy("lit-html",{createHTML:t=>t}):void 0,Ns=t=>t,Ot=(t,e,o)=>Ns,Ps=t=>{if(_e!==Ot)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");_e=t},As=()=>{_e=Ot},Eo=(t,e,o)=>_e(t,e,o),Co="$lit$",ne=`lit$${String(Math.random()).slice(9)}$`,pi="?"+ne,Is=`<${pi}>`,ye=document,qe=()=>ye.createComment(""),We=t=>t===null||typeof t!="object"&&typeof t!="function",mi=Array.isArray,Rs=t=>mi(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",to=`[ 	
\f\r]`,Os=`[^ 	
\f\r"'\`<>=]`,Ls=`[^\\s"'>=/]`,ze=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_n=1,oo=2,Ms=3,wn=/-->/g,Sn=/>/g,me=new RegExp(`>|${to}(?:(${Ls}+)(${to}*=${to}*(?:${Os}|("|')|))|$)`,"g"),Vs=0,xn=1,Ds=2,En=3,no=/'/g,io=/"/g,fi=/^(?:script|style|textarea|title)$/i,zs=1,Et=2,Ro=1,Ct=2,Us=3,js=4,Fs=5,Oo=6,Bs=7,vi=t=>(e,...o)=>(e.some(n=>n===void 0)&&console.warn(`Some template strings are undefined.
This is probably caused by illegal octal escape sequences.`),{_$litType$:t,strings:e,values:o}),v=vi(zs),Te=vi(Et),be=Symbol.for("lit-noChange"),C=Symbol.for("lit-nothing"),Cn=new WeakMap,ve=ye.createTreeWalker(ye,129,null,!1);let _e=Ot;function gi(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw")){let o="invalid template strings array";throw o=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(o)}return bn!==void 0?bn.createHTML(e):e}const Hs=(t,e)=>{const o=t.length-1,n=[];let i=e===Et?"<svg>":"",s,r=ze;for(let a=0;a<o;a++){const d=t[a];let c=-1,m,h=0,f;for(;h<d.length&&(r.lastIndex=h,f=r.exec(d),f!==null);)if(h=r.lastIndex,r===ze){if(f[_n]==="!--")r=wn;else if(f[_n]!==void 0)r=Sn;else if(f[oo]!==void 0)fi.test(f[oo])&&(s=new RegExp(`</${f[oo]}`,"g")),r=me;else if(f[Ms]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else r===me?f[Vs]===">"?(r=s??ze,c=-1):f[xn]===void 0?c=-2:(c=r.lastIndex-f[Ds].length,m=f[xn],r=f[En]===void 0?me:f[En]==='"'?io:no):r===io||r===no?r=me:r===wn||r===Sn?r=ze:(r=me,s=void 0);console.assert(c===-1||r===me||r===no||r===io,"unexpected parse state B");const se=r===me&&t[a+1].startsWith("/>")?" ":"";i+=r===ze?d+Is:c>=0?(n.push(m),d.slice(0,c)+Co+d.slice(c)+ne+se):d+ne+(c===-2?(n.push(void 0),a):se)}const l=i+(t[o]||"<?>")+(e===Et?"</svg>":"");return[gi(t,l),n]};class Ge{constructor({strings:e,["_$litType$"]:o},n){this.parts=[];let i,s=0,r=0;const l=e.length-1,a=this.parts,[d,c]=Hs(e,o);if(this.el=Ge.createElement(d,n),ve.currentNode=this.el.content,o===Et){const m=this.el.content,h=m.firstChild;h.remove(),m.append(...h.childNodes)}for(;(i=ve.nextNode())!==null&&a.length<l;){if(i.nodeType===1){{const m=i.localName;if(/^(?:textarea|template)$/i.test(m)&&i.innerHTML.includes(ne)){const h=`Expressions are not supported inside \`${m}\` elements. See https://lit.dev/msg/expression-in-${m} for more information.`;if(m==="template")throw new Error(h);xt("",h)}}if(i.hasAttributes()){const m=[];for(const h of i.getAttributeNames())if(h.endsWith(Co)||h.startsWith(ne)){const f=c[r++];if(m.push(h),f!==void 0){const re=i.getAttribute(f.toLowerCase()+Co).split(ne),te=/([.?@])?(.*)/.exec(f);a.push({type:Ro,index:s,name:te[2],strings:re,ctor:te[1]==="."?Ws:te[1]==="?"?Ks:te[1]==="@"?Ys:Lt})}else a.push({type:Oo,index:s})}for(const h of m)i.removeAttribute(h)}if(fi.test(i.tagName)){const m=i.textContent.split(ne),h=m.length-1;if(h>0){i.textContent=Re?Re.emptyScript:"";for(let f=0;f<h;f++)i.append(m[f],qe()),ve.nextNode(),a.push({type:Ct,index:++s});i.append(m[h],qe())}}}else if(i.nodeType===8)if(i.data===pi)a.push({type:Ct,index:s});else{let h=-1;for(;(h=i.data.indexOf(ne,h+1))!==-1;)a.push({type:Bs,index:s}),h+=ne.length-1}s++}g==null||g({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,o){const n=ye.createElement("template");return n.innerHTML=e,n}}function Oe(t,e,o=t,n){var i,s,r,l;if(e===be)return e;let a=n!==void 0?(i=o.__directives)===null||i===void 0?void 0:i[n]:o.__directive;const d=We(e)?void 0:e._$litDirective$;return(a==null?void 0:a.constructor)!==d&&((s=a==null?void 0:a._$notifyDirectiveConnectionChanged)===null||s===void 0||s.call(a,!1),d===void 0?a=void 0:(a=new d(t),a._$initialize(t,o,n)),n!==void 0?((r=(l=o).__directives)!==null&&r!==void 0?r:l.__directives=[])[n]=a:o.__directive=a),a!==void 0&&(e=Oe(t,a._$resolve(t,e.values),a,n)),e}class qs{constructor(e,o){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=o}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){var o;const{el:{content:n},parts:i}=this._$template,s=((o=e==null?void 0:e.creationScope)!==null&&o!==void 0?o:ye).importNode(n,!0);ve.currentNode=s;let r=ve.nextNode(),l=0,a=0,d=i[0];for(;d!==void 0;){if(l===d.index){let c;d.type===Ct?c=new et(r,r.nextSibling,this,e):d.type===Ro?c=new d.ctor(r,d.name,d.strings,this,e):d.type===Oo&&(c=new Js(r,this,e)),this._$parts.push(c),d=i[++a]}l!==(d==null?void 0:d.index)&&(r=ve.nextNode(),l++)}return ve.currentNode=ye,s}_update(e){let o=0;for(const n of this._$parts)n!==void 0&&(g==null||g({kind:"set part",part:n,value:e[o],valueIndex:o,values:e,templateInstance:this}),n.strings!==void 0?(n._$setValue(e,n,o),o+=n.strings.length-2):n._$setValue(e[o])),o++}}class et{constructor(e,o,n,i){var s;this.type=Ct,this._$committedValue=C,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=o,this._$parent=n,this.options=i,this.__isConnected=(s=i==null?void 0:i.isConnected)!==null&&s!==void 0?s:!0,this._textSanitizer=void 0}get _$isConnected(){var e,o;return(o=(e=this._$parent)===null||e===void 0?void 0:e._$isConnected)!==null&&o!==void 0?o:this.__isConnected}get parentNode(){let e=H(this._$startNode).parentNode;const o=this._$parent;return o!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=o.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,o=this){var n;if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=Oe(this,e,o),We(e))e===C||e==null||e===""?(this._$committedValue!==C&&(g==null||g({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=C):e!==this._$committedValue&&e!==be&&this._commitText(e);else if(e._$litType$!==void 0)this._commitTemplateResult(e);else if(e.nodeType!==void 0){if(((n=this.options)===null||n===void 0?void 0:n.host)===e){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(e)}else Rs(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return H(H(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){var o;if(this._$committedValue!==e){if(this._$clear(),_e!==Ot){const n=(o=this._$startNode.parentNode)===null||o===void 0?void 0:o.nodeName;if(n==="STYLE"||n==="SCRIPT"){let i="Forbidden";throw n==="STYLE"?i="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":i="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(i)}}g==null||g({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==C&&We(this._$committedValue)){const o=H(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=Eo(o,"data","property")),e=this._textSanitizer(e),g==null||g({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}else{const o=ye.createTextNode("");this._commitNode(o),this._textSanitizer===void 0&&(this._textSanitizer=Eo(o,"data","property")),e=this._textSanitizer(e),g==null||g({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}this._$committedValue=e}_commitTemplateResult(e){var o;const{values:n,["_$litType$"]:i}=e,s=typeof i=="number"?this._$getTemplate(e):(i.el===void 0&&(i.el=Ge.createElement(gi(i.h,i.h[0]),this.options)),i);if(((o=this._$committedValue)===null||o===void 0?void 0:o._$template)===s)g==null||g({kind:"template updating",template:s,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:n}),this._$committedValue._update(n);else{const r=new qs(s,this),l=r._clone(this.options);g==null||g({kind:"template instantiated",template:s,instance:r,parts:r._$parts,options:this.options,fragment:l,values:n}),r._update(n),g==null||g({kind:"template instantiated and updated",template:s,instance:r,parts:r._$parts,options:this.options,fragment:l,values:n}),this._commitNode(l),this._$committedValue=r}}_$getTemplate(e){let o=Cn.get(e.strings);return o===void 0&&Cn.set(e.strings,o=new Ge(e)),o}_commitIterable(e){mi(this._$committedValue)||(this._$committedValue=[],this._$clear());const o=this._$committedValue;let n=0,i;for(const s of e)n===o.length?o.push(i=new et(this._insert(qe()),this._insert(qe()),this,this.options)):i=o[n],i._$setValue(s),n++;n<o.length&&(this._$clear(i&&H(i._$endNode).nextSibling,n),o.length=n)}_$clear(e=H(this._$startNode).nextSibling,o){var n;for((n=this._$notifyConnectionChanged)===null||n===void 0||n.call(this,!1,!0,o);e&&e!==this._$endNode;){const i=H(e).nextSibling;H(e).remove(),e=i}}setConnected(e){var o;if(this._$parent===void 0)this.__isConnected=e,(o=this._$notifyConnectionChanged)===null||o===void 0||o.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class Lt{constructor(e,o,n,i,s){this.type=Ro,this._$committedValue=C,this._$disconnectableChildren=void 0,this.element=e,this.name=o,this._$parent=i,this.options=s,n.length>2||n[0]!==""||n[1]!==""?(this._$committedValue=new Array(n.length-1).fill(new String),this.strings=n):this._$committedValue=C,this._sanitizer=void 0}get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e,o=this,n,i){const s=this.strings;let r=!1;if(s===void 0)e=Oe(this,e,o,0),r=!We(e)||e!==this._$committedValue&&e!==be,r&&(this._$committedValue=e);else{const l=e;e=s[0];let a,d;for(a=0;a<s.length-1;a++)d=Oe(this,l[n+a],o,a),d===be&&(d=this._$committedValue[a]),r||(r=!We(d)||d!==this._$committedValue[a]),d===C?e=C:e!==C&&(e+=(d??"")+s[a+1]),this._$committedValue[a]=d}r&&!i&&this._commitValue(e)}_commitValue(e){e===C?H(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=_e(this.element,this.name,"attribute")),e=this._sanitizer(e??""),g==null||g({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),H(this.element).setAttribute(this.name,e??""))}}class Ws extends Lt{constructor(){super(...arguments),this.type=Us}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=_e(this.element,this.name,"property")),e=this._sanitizer(e),g==null||g({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===C?void 0:e}}const Gs=Re?Re.emptyScript:"";class Ks extends Lt{constructor(){super(...arguments),this.type=js}_commitValue(e){g==null||g({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==C),options:this.options}),e&&e!==C?H(this.element).setAttribute(this.name,Gs):H(this.element).removeAttribute(this.name)}}class Ys extends Lt{constructor(e,o,n,i,s){if(super(e,o,n,i,s),this.type=Fs,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${o}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,o=this){var n;if(e=(n=Oe(this,e,o,0))!==null&&n!==void 0?n:C,e===be)return;const i=this._$committedValue,s=e===C&&i!==C||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==C&&(i===C||s);g==null||g({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:s,addListener:r,oldListener:i}),s&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var o,n;typeof this._$committedValue=="function"?this._$committedValue.call((n=(o=this.options)===null||o===void 0?void 0:o.host)!==null&&n!==void 0?n:this.element,e):this._$committedValue.handleEvent(e)}}class Js{constructor(e,o,n){this.element=e,this.type=Oo,this._$disconnectableChildren=void 0,this._$parent=o,this.options=n}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){g==null||g({kind:"commit to element binding",element:this.element,value:e,options:this.options}),Oe(this,e)}}const so=U.litHtmlPolyfillSupportDevMode;so==null||so(Ge,et);((eo=U.litHtmlVersions)!==null&&eo!==void 0?eo:U.litHtmlVersions=[]).push("2.7.5");U.litHtmlVersions.length>1&&xt("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");const Ae=(t,e,o)=>{var n,i;if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const s=Ts++,r=(n=o==null?void 0:o.renderBefore)!==null&&n!==void 0?n:e;let l=r._$litPart$;if(g==null||g({kind:"begin render",id:s,value:t,container:e,options:o,part:l}),l===void 0){const a=(i=o==null?void 0:o.renderBefore)!==null&&i!==void 0?i:null;r._$litPart$=l=new et(e.insertBefore(qe(),a),a,void 0,o??{})}return l._$setValue(t),g==null||g({kind:"end render",id:s,value:t,container:e,options:o,part:l}),l};Ae.setSanitizer=Ps,Ae.createSanitizer=Eo,Ae._testOnlyClearSanitizerFactoryDoNotCallOrElse=As;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ro,ao,lo;let Lo;{const t=(ro=globalThis.litIssuedWarnings)!==null&&ro!==void 0?ro:globalThis.litIssuedWarnings=new Set;Lo=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))}}class A extends ee{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){var e,o;const n=super.createRenderRoot();return(e=(o=this.renderOptions).renderBefore)!==null&&e!==void 0||(o.renderBefore=n.firstChild),n}update(e){const o=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=Ae(o,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this.__childPart)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.__childPart)===null||e===void 0||e.setConnected(!1)}render(){return be}}A.finalized=!0;A._$litElement$=!0;(ao=globalThis.litElementHydrateSupport)===null||ao===void 0||ao.call(globalThis,{LitElement:A});const co=globalThis.litElementPolyfillSupportDevMode;co==null||co({LitElement:A});A.finalize=function(){if(!ee.finalize.call(this))return!1;const e=(o,n,i=!1)=>{if(o.hasOwnProperty(n)){const s=(typeof o=="function"?o:o.constructor).name;Lo(i?"renamed-api":"removed-api",`\`${n}\` is implemented on class ${s}. It has been ${i?"renamed":"removed"} in this version of LitElement.`)}};return e(this,"render"),e(this,"getStyles",!0),e(this.prototype,"adoptStyles"),!0};((lo=globalThis.litElementVersions)!==null&&lo!==void 0?lo:globalThis.litElementVersions=[]).push("3.3.2");globalThis.litElementVersions.length>1&&Lo("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xs=(t,e)=>(customElements.define(t,e),e),Qs=(t,e)=>{const{kind:o,elements:n}=e;return{kind:o,elements:n,finisher(i){customElements.define(t,i)}}},F=t=>e=>typeof e=="function"?Xs(t,e):Qs(t,e);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Zs=(t,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(o){o.createProperty(e.key,t)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(o){o.createProperty(e.key,t)}},er=(t,e,o)=>{e.constructor.createProperty(o,t)};function y(t){return(e,o)=>o!==void 0?er(t,e,o):Zs(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const tr=({finisher:t,descriptor:e})=>(o,n)=>{var i;if(n!==void 0){const s=o.constructor;e!==void 0&&Object.defineProperty(o,n,e(n)),t==null||t(s,n)}else{const s=(i=o.originalKey)!==null&&i!==void 0?i:o.key,r=e!=null?{kind:"method",placement:"prototype",key:s,descriptor:e(o.key)}:{...o,key:s};return t!=null&&(r.finisher=function(l){t(l,s)}),r}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function tt(t,e){return tr({descriptor:o=>{const n={get(){var i,s;return(s=(i=this.renderRoot)===null||i===void 0?void 0:i.querySelector(t))!==null&&s!==void 0?s:null},enumerable:!0,configurable:!0};if(e){const i=typeof o=="symbol"?Symbol():`__${o}`;n.get=function(){var s,r;return this[i]===void 0&&(this[i]=(r=(s=this.renderRoot)===null||s===void 0?void 0:s.querySelector(t))!==null&&r!==void 0?r:null),this[i]}}return n}})}/**
 * @license
...
`);async function Ar(t){const e=new ce(t),o=document.createElement(t.tagName);o.classList.add(Pn),document.body.append(o),t.setupElement&&await t.setupElement(o);const n={themeScope:z.local,localClassName:Pn};try{t.elements.forEach(i=>{Rn(o,i,n,!0);let s=Le(i,n);const r=s.match(An);s=s.replace(An,"");const l=s.match(In),a=s.replace(In,"");let d=document.querySelector(a);if(d&&l){const h=`[part~="${l[1]}"]`;d=d.shadowRoot.querySelector(h)}if(!d)return;d.style.transition="none";const c=r?r[1]:null,m=getComputedStyle(d,c);i.properties.forEach(h=>{const f=m.getPropertyValue(h.propertyName)||h.defaultValue||"";e.updatePropertyValue(i.selector,h.propertyName,f)}),Rn(o,i,n,!1)})}finally{try{t.cleanupElement&&await t.cleanupElement(o)}finally{o.remove()}}return e}function Rn(t,e,o,n){if(e.stateAttribute){if(e.stateElementSelector){const i=Le({...e,selector:e.stateElementSelector},o);t=document.querySelector(i)}t&&(n?t.setAttribute(e.stateAttribute,""):t.removeAttribute(e.stateAttribute))}}function On(t){return t.trim()}function Ir(t){const e=t.element;if(!e)return null;const o=e.querySelector("label");if(o&&o.textContent)return On(o.textContent);const n=e.textContent;return n?On(n):null}class Rr{constructor(){this._localClassNameMap=new Map}get stylesheet(){return this.ensureStylesheet(),this._stylesheet}add(e){this.ensureStylesheet(),this._stylesheet.replaceSync(e)}clear(){this.ensureStylesheet(),this._stylesheet.replaceSync("")}previewLocalClassName(e,o){if(!e)return;const n=this._localClassNameMap.get(e);n&&(e.classList.remove(n),e.overlayClass=null),o?(e.classList.add(o),e.overlayClass=o,this._localClassNameMap.set(e,o)):this._localClassNameMap.delete(e)}ensureStylesheet(){this._stylesheet||(this._stylesheet=new CSSStyleSheet,this._stylesheet.replaceSync(""),document.adoptedStyleSheets=[...document.adoptedStyleSheets,this._stylesheet])}}const fe=new Rr;class Or{constructor(e){this.pendingRequests={},this.requestCounter=0,this.globalUiId=this.getGlobalUiId(),this.wrappedConnection=e;const o=this.wrappedConnection.onMessage;this.wrappedConnection.onMessage=n=>{n.command==="themeEditorResponse"?this.handleResponse(n.data):o.call(this.wrappedConnection,n)}}sendRequest(e,o){const n=(this.requestCounter++).toString(),i=o.uiId??this.globalUiId;return new Promise((s,r)=>{this.wrappedConnection.send(e,{...o,requestId:n,uiId:i}),this.pendingRequests[n]={resolve:s,reject:r}})}handleResponse(e){const o=this.pendingRequests[e.requestId];if(!o){console.warn("Received response for unknown request");return}delete this.pendingRequests[e.requestId],e.code==="ok"?o.resolve(e):o.reject(e)}loadComponentMetadata(e){return this.sendRequest("themeEditorComponentMetadata",{nodeId:e.nodeId})}setLocalClassName(e,o){return this.sendRequest("themeEditorLocalClassName",{nodeId:e.nodeId,className:o})}setCssRules(e){return this.sendRequest("themeEditorRules",{rules:e})}loadRules(e){return this.sendRequest("themeEditorLoadRules",{selectors:e})}markAsUsed(){return this.sendRequest("themeEditorMarkAsUsed",{})}undo(e){return this.sendRequest("themeEditorHistory",{undo:e})}redo(e){return this.sendRequest("themeEditorHistory",{redo:e})}openCss(e){return this.sendRequest("themeEditorOpenCss",{selector:e})}getGlobalUiId(){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,n=Object.keys(o);for(const i of n){const s=o[i];if(s.getNodeId)return s.getUIId()}}return-1}}const O={index:-1,entries:[]};class Lr{constructor(e){this.api=e}get allowUndo(){return O.index>=0}get allowRedo(){return O.index<O.entries.length-1}get allowedActions(){return{allowUndo:this.allowUndo,allowRedo:this.allowRedo}}push(e,o,n){const i={requestId:e,execute:o,rollback:n};if(O.index++,O.entries=O.entries.slice(0,O.index),O.entries.push(i),o)try{o()}catch(s){console.error("Execute history entry failed",s)}return this.allowedActions}async undo(){if(!this.allowUndo)return this.allowedActions;const e=O.entries[O.index];O.index--;try{await this.api.undo(e.requestId),e.rollback&&e.rollback()}catch(o){console.error("Undo failed",o)}return this.allowedActions}async redo(){if(!this.allowRedo)return this.allowedActions;O.index++;const e=O.entries[O.index];try{await this.api.redo(e.requestId),e.execute&&e.execute()}catch(o){console.error("Redo failed",o)}return this.allowedActions}static clear(){O.entries=[],O.index=-1}}var Mr=Object.defineProperty,Vr=Object.getOwnPropertyDescriptor,ue=(t,e,o,n)=>{for(var i=n>1?void 0:n?Vr(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&Mr(e,o,i),i};class Dr extends CustomEvent{constructor(e,o,n){super("theme-property-value-change",{bubbles:!0,composed:!0,detail:{element:e,property:o,value:n}})}}class q extends A{constructor(){super(...arguments),this.value=""}static get styles(){return[_i,E`
    ...
    `}handleInputChange(t){const e=t.target;this.dispatchEvent(new Ln(e.value))}handleClearClick(){this.dispatchEvent(new Ln(""))}};ue([y({})],$t.prototype,"value",2);ue([y({})],$t.prototype,"showClearButton",2);$t=ue([F("vaadin-dev-tools-theme-text-input")],$t);var zr=Object.defineProperty,Ur=Object.getOwnPropertyDescriptor,Mt=(t,e,o,n)=>{for(var i=n>1?void 0:n?Ur(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&zr(e,o,i),i};class jr extends CustomEvent{constructor(e){super("class-name-change",{detail:{value:e}})}}let Je=class extends A{constructor(){super(...arguments),this.editedClassName="",this.invalid=!1}static get styles(){return[_i,E`
        .editor-row {
          padding-top: 0;
        }
    ...
    </div>`}handleInputChange(t){this.editedClassName=t.detail.value;const e=/^-?[_a-zA-Z]+[_a-zA-Z0-9-]*$/;this.invalid=!this.editedClassName.match(e),!this.invalid&&this.editedClassName!==this.className&&this.dispatchEvent(new jr(this.editedClassName))}};Mt([y({})],Je.prototype,"className",2);Mt([T()],Je.prototype,"editedClassName",2);Mt([T()],Je.prototype,"invalid",2);Je=Mt([F("vaadin-dev-tools-theme-class-name-editor")],Je);var Fr=Object.defineProperty,Br=Object.getOwnPropertyDescriptor,Vt=(t,e,o,n)=>{for(var i=n>1?void 0:n?Br(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&Fr(e,o,i),i};class Hr extends CustomEvent{constructor(e){super("scope-change",{detail:{value:e}})}}Vo(E`
...
`);let Xe=class extends A{constructor(){super(...arguments),this.value=z.local}static get styles(){return E`
    ...
    ></vaadin-select>`}selectRenderer(t){var e;const o=((e=this.metadata)==null?void 0:e.displayName)||"Component",n=`${o}s`;Ae(v`
      ...
      `,t)}handleValueChange(t){const e=t.detail.value;e!==this.value&&this.dispatchEvent(new Hr(e))}};Vt([y({})],Xe.prototype,"value",2);Vt([y({})],Xe.prototype,"metadata",2);Vt([tt("vaadin-select")],Xe.prototype,"select",2);Xe=Vt([F("vaadin-dev-tools-theme-scope-selector")],Xe);var qr=Object.defineProperty,Wr=Object.getOwnPropertyDescriptor,Gr=(t,e,o,n)=>{for(var i=n>1?void 0:n?Wr(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&qr(e,o,i),i};let Mn=class extends q{static get styles(){return[q.styles,E`
        .editor-row {
          align-items: center;
        }
      `]}handleInputChange(t){const e=t.target.checked?this.propertyMetadata.checkedValue:"";this.dispatchChange(e||"")}renderEditor(){const t=this.value===this.propertyMetadata.checkedValue;return v` <input type="checkbox" .checked=${t} @change=${this.handleInputChange} /> `}};Mn=Gr([F("vaadin-dev-tools-theme-checkbox-property-editor")],Mn);var Kr=Object.defineProperty,Yr=Object.getOwnPropertyDescriptor,Jr=(t,e,o,n)=>{for(var i=n>1?void 0:n?Yr(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&Kr(e,o,i),i};let Vn=class extends q{handleInputChange(t){this.dispatchChange(t.detail.value)}renderEditor(){var t;return v`
      <vaadin-dev-tools-theme-text-input
        .value=${this.value}
        .showClearButton=${((t=this.propertyValue)==null?void 0:t.modified)||!1}
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};Vn=Jr([F("vaadin-dev-tools-theme-text-property-editor")],Vn);var Xr=Object.defineProperty,Qr=Object.getOwnPropertyDescriptor,Do=(t,e,o,n)=>{for(var i=n>1?void 0:n?Qr(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&Xr(e,o,i),i};let Tt=class extends q{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new kt}static get styles(){return[q.styles,E`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
      ...
      `]}update(t){t.has("propertyMetadata")&&(this.presets=new kt(this.propertyMetadata)),super.update(t)}renderEditor(){var t;const e={"slider-wrapper":!0,"custom-value":this.selectedPresetIndex<0},o=this.presets.values.length;return v`
      <div class=${Mo(e)}>
        ${null}
        <input
          type="range"
      ...
      ></vaadin-dev-tools-theme-text-input>
    `}handleSliderInput(t){const e=t.target,o=parseInt(e.value),n=this.presets.values[o];this.selectedPresetIndex=o,this.value=this.presets.rawValues[n]}handleSliderChange(){this.dispatchChange(this.value)}handleValueChange(t){this.value=t.detail.value,this.updateSliderValue(),this.dispatchChange(this.value)}dispatchChange(t){const e=this.presets.tryMapToPreset(t);super.dispatchChange(e)}updateValueFromTheme(){var t;super.updateValueFromTheme(),this.value=this.presets.tryMapToRawValue(((t=this.propertyValue)==null?void 0:t.value)||""),this.updateSliderValue()}updateSliderValue(){const t=this.presets.findPreset(this.value);this.selectedPresetIndex=t?this.presets.values.indexOf(t):-1}};Do([T()],Tt.prototype,"selectedPresetIndex",2);Do([T()],Tt.prototype,"presets",2);Tt=Do([F("vaadin-dev-tools-theme-range-property-editor")],Tt);const Me=(t,e=0,o=1)=>t>o?o:t<e?e:t,V=(t,e=0,o=Math.pow(10,e))=>Math.round(o*t)/o,wi=({h:t,s:e,v:o,a:n})=>{const i=(200-e)*o/100;return{h:V(t),s:V(i>0&&i<200?e*o/100/(i<=100?i:200-i)*100:0),l:V(i/2),a:V(n,2)}},ko=t=>{const{h:e,s:o,l:n}=wi(t);return`hsl(${e}, ${o}%, ${n}%)`},mo=t=>{const{h:e,s:o,l:n,a:i}=wi(t);return`hsla(${e}, ${o}%, ${n}%, ${i})`},Zr=({h:t,s:e,v:o,a:n})=>{t=t/360*6,e=e/100,o=o/100;const i=Math.floor(t),s=o*(1-e),r=o*(1-(t-i)*e),l=o*(1-(1-t+i)*e),a=i%6;return{r:V([o,r,s,s,l,o][a]*255),g:V([l,o,o,r,s,s][a]*255),b:V([s,s,l,o,o,r][a]*255),a:V(n,2)}},ea=t=>{const{r:e,g:o,b:n,a:i}=Zr(t);return`rgba(${e}, ${o}, ${n}, ${i})`},ta=t=>{const e=/rgba?\(?\s*(-?\d*\.?\d+)(%)?[,\s]+(-?\d*\.?\d+)(%)?[,\s]+(-?\d*\.?\d+)(%)?,?\s*[/\s]*(-?\d*\.?\d+)?(%)?\s*\)?/i.exec(t);return e?oa({r:Number(e[1])/(e[2]?100/255:1),g:Number(e[3])/(e[4]?100/255:1),b:Number(e[5])/(e[6]?100/255:1),a:e[7]===void 0?1:Number(e[7])/(e[8]?100:1)}):{h:0,s:0,v:0,a:1}},oa=({r:t,g:e,b:o,a:n})=>{const i=Math.max(t,e,o),s=i-Math.min(t,e,o),r=s?i===t?(e-o)/s:i===e?2+(o-t)/s:4+(t-e)/s:0;return{h:V(60*(r<0?r+6:r)),s:V(i?s/i*100:0),v:V(i/255*100),a:n}},na=(t,e)=>{if(t===e)return!0;for(const o in t)if(t[o]!==e[o])return!1;return!0},ia=(t,e)=>t.replace(/\s/g,"")===e.replace(/\s/g,""),Dn={},Si=t=>{let e=Dn[t];return e||(e=document.createElement("template"),e.innerHTML=t,Dn[t]=e),e},zo=(t,e,o)=>{t.dispatchEvent(new CustomEvent(e,{bubbles:!0,detail:o}))};let Ie=!1;const $o=t=>"touches"in t,sa=t=>Ie&&!$o(t)?!1:(Ie||(Ie=$o(t)),!0),zn=(t,e)=>{const o=$o(e)?e.touches[0]:e,n=t.el.getBoundingClientRect();zo(t.el,"move",t.getMove({x:Me((o.pageX-(n.left+window.pageXOffset))/n.width),y:Me((o.pageY-(n.top+window.pageYOffset))/n.height)}))},ra=(t,e)=>{const o=e.keyCode;o>40||t.xy&&o<37||o<33||(e.preventDefault(),zo(t.el,"move",t.getMove({x:o===39?.01:o===37?-.01:o===34?.05:o===33?-.05:o===35?1:o===36?-1:0,y:o===40?.01:o===38?-.01:0},!0)))};class Uo{constructor(e,o,n,i){const s=Si(`<div role="slider" tabindex="0" part="${o}" ${n}><div part="${o}-pointer"></div></div>`);e.appendChild(s.content.cloneNode(!0));const r=e.querySelector(`[part=${o}]`);r.addEventListener("mousedown",this),r.addEventListener("touchstart",this),r.addEventListener("keydown",this),this.el=r,this.xy=i,this.nodes=[r.firstChild,r]}set dragging(e){const o=e?document.addEventListener:document.removeEventListener;o(Ie?"touchmove":"mousemove",this),o(Ie?"touchend":"mouseup",this)}handleEvent(e){switch(e.type){case"mousedown":case"touchstart":if(e.preventDefault(),!sa(e)||!Ie&&e.button!=0)return;this.el.focus(),zn(this,e),this.dragging=!0;break;case"mousemove":case"touchmove":e.preventDefault(),zn(this,e);break;case"mouseup":case"touchend":this.dragging=!1;break;case"keydown":ra(this,e);break}}style(e){e.forEach((o,n)=>{for(const i in o)this.nodes[n].style.setProperty(i,o[i])})}}class aa extends Uo{constructor(e){super(e,"hue",'aria-label="Hue" aria-valuemin="0" aria-valuemax="360"',!1)}update({h:e}){this.h=e,this.style([{left:`${e/360*100}%`,color:ko({h:e,s:100,v:100,a:1})}]),this.el.setAttribute("aria-valuenow",`${V(e)}`)}getMove(e,o){return{h:o?Me(this.h+e.x*360,0,360):360*e.x}}}class la extends Uo{constructor(e){super(e,"saturation",'aria-label="Color"',!0)}update(e){this.hsva=e,this.style([{top:`${100-e.v}%`,left:`${e.s}%`,color:ko(e)},{"background-color":ko({h:e.h,s:100,v:100,a:1})}]),this.el.setAttribute("aria-valuetext",`Saturation ${V(e.s)}%, Brightness ${V(e.v)}%`)}getMove(e,o){return{s:o?Me(this.hsva.s+e.x*100,0,100):e.x*100,v:o?Me(this.hsva.v-e.y*100,0,100):Math.round(100-e.y*100)}}}const da=':host{display:flex;flex-direction:column;position:relative;width:200px;height:200px;user-select:none;-webkit-user-select:none;cursor:default}:host([hidden]){display:none!important}[role=slider]{position:relative;touch-action:none;user-select:none;-webkit-user-select:none;outline:0}[role=slider]:last-child{border-radius:0 0 8px 8px}[part$=pointer]{position:absolute;z-index:1;box-sizing:border-box;width:28px;height:28px;display:flex;place-content:center center;transform:translate(-50%,-50%);background-color:#fff;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2)}[part$=pointer]::after{content:"";width:100%;height:100%;border-radius:inherit;background-color:currentColor}[role=slider]:focus [part$=pointer]{transform:translate(-50%,-50%) scale(1.1)}',ca="[part=hue]{flex:0 0 24px;background:linear-gradient(to right,red 0,#ff0 17%,#0f0 33%,#0ff 50%,#00f 67%,#f0f 83%,red 100%)}[part=hue-pointer]{top:50%;z-index:2}",ha="[part=saturation]{flex-grow:1;border-color:transparent;border-bottom:12px solid #000;border-radius:8px 8px 0 0;background-image:linear-gradient(to top,#000,transparent),linear-gradient(to right,#fff,rgba(255,255,255,0));box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}[part=saturation-pointer]{z-index:3}",ut=Symbol("same"),fo=Symbol("color"),Un=Symbol("hsva"),vo=Symbol("update"),jn=Symbol("parts"),Nt=Symbol("css"),Pt=Symbol("sliders");let ua=class extends HTMLElement{static get observedAttributes(){return["color"]}get[Nt](){return[da,ca,ha]}get[Pt](){return[la,aa]}get color(){return this[fo]}set color(t){if(!this[ut](t)){const e=this.colorModel.toHsva(t);this[vo](e),this[fo]=t}}constructor(){super();const t=Si(`<style>${this[Nt].join("")}</style>`),e=this.attachShadow({mode:"open"});e.appendChild(t.content.cloneNode(!0)),e.addEventListener("move",this),this[jn]=this[Pt].map(o=>new o(e))}connectedCallback(){if(this.hasOwnProperty("color")){const t=this.color;delete this.color,this.color=t}else this.color||(this.color=this.colorModel.defaultColor)}attributeChangedCallback(t,e,o){const n=this.colorModel.fromAttr(o);this[ut](n)||(this.color=n)}handleEvent(t){const e=this[Un],o={...e,...t.detail};this[vo](o);let n;!na(o,e)&&!this[ut](n=this.colorModel.fromHsva(o))&&(this[fo]=n,zo(this,"color-changed",{value:n}))}[ut](t){return this.color&&this.colorModel.equal(t,this.color)}[vo](t){this[Un]=t,this[jn].forEach(e=>e.update(t))}};class pa extends Uo{constructor(e){super(e,"alpha",'aria-label="Alpha" aria-valuemin="0" aria-valuemax="1"',!1)}update(e){this.hsva=e;const o=mo({...e,a:0}),n=mo({...e,a:1}),i=e.a*100;this.style([{left:`${i}%`,color:mo(e)},{"--gradient":`linear-gradient(90deg, ${o}, ${n}`}]);const s=V(i);this.el.setAttribute("aria-valuenow",`${s}`),this.el.setAttribute("aria-valuetext",`${s}%`)}getMove(e,o){return{a:o?Me(this.hsva.a+e.x):e.x}}}const ma=`[part=alpha]{flex:0 0 24px}[part=alpha]::after{display:block;content:"";position:absolute;top:0;left:0;right:0;bottom:0;border-radius:inherit;background-image:var(--gradient);box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}[part^=alpha]{background-color:#fff;background-image:url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><rect x="8" width="8" height="8"/><rect y="8" width="8" height="8"/></svg>')}[part=alpha-pointer]{top:50%}`;class fa extends ua{get[Nt](){return[...super[Nt],ma]}get[Pt](){return[...super[Pt],pa]}}const va={defaultColor:"rgba(0, 0, 0, 1)",toHsva:ta,fromHsva:ea,equal:ia,fromAttr:t=>t};class ga extends fa{get colorModel(){return va}}/**
* @license
* Copyright (c) 2017 - 2023 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/function ya(t){const e=[];for(;t;){if(t.nodeType===Node.DOCUMENT_NODE){e.push(t);break}if(t.nodeType===Node.DOCUMENT_FRAGMENT_NODE){e.push(t),t=t.host;continue}if(t.assignedSlot){t=t.assignedSlot;continue}t=t.parentNode}return e}const go={start:"top",end:"bottom"},yo={start:"left",end:"right"},Fn=new ResizeObserver(t=>{setTimeout(()=>{t.forEach(e=>{e.target.__overlay&&e.target.__overlay._updatePosition()})})}),ba=t=>class extends t{static get properties(){return{positionTarget:{type:Object,value:null},horizontalAlign:{type:String,value:"start"},verticalAlign:{type:String,value:"top"},noHorizontalOverlap:{type:Boolean,value:!1},noVerticalOverlap:{type:Boolean,value:!1},requiredVerticalSpace:{type:Number,value:0}}}static get observers(){return["__positionSettingsChanged(horizontalAlign, verticalAlign, noHorizontalOverlap, noVerticalOverlap, requiredVerticalSpace)","__overlayOpenedChanged(opened, positionTarget)"]}constructor(){super(),this.__onScroll=this.__onScroll.bind(this),this._updatePosition=this._updatePosition.bind(this)}connectedCallback(){super.connectedCallback(),this.opened&&this.__addUpdatePositionEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.__removeUpdatePositionEventListeners()}__addUpdatePositionEventListeners(){window.addEventListener("resize",this._updatePosition),this.__positionTargetAncestorRootNodes=ya(this.positionTarget),this.__positionTargetAncestorRootNodes.forEach(e=>{e.addEventListener("scroll",this.__onScroll,!0)})}__removeUpdatePositionEventListeners(){window.removeEventListener("resize",this._updatePosition),this.__positionTargetAncestorRootNodes&&(this.__positionTargetAncestorRootNodes.forEach(e=>{e.removeEventListener("scroll",this.__onScroll,!0)}),this.__positionTargetAncestorRootNodes=null)}__overlayOpenedChanged(e,o){if(this.__removeUpdatePositionEventListeners(),o&&(o.__overlay=null,Fn.unobserve(o),e&&(this.__addUpdatePositionEventListeners(),o.__overlay=this,Fn.observe(o))),e){const n=getComputedStyle(this);this.__margins||(this.__margins={},["top","bottom","left","right"].forEach(i=>{this.__margins[i]=parseInt(n[i],10)})),this.setAttribute("dir",n.direction),this._updatePosition(),requestAnimationFrame(()=>this._updatePosition())}}__positionSettingsChanged(){this._updatePosition()}__onScroll(e){this.contains(e.target)||this._updatePosition()}_updatePosition(){if(!this.positionTarget||!this.opened)return;const e=this.positionTarget.getBoundingClientRect(),o=this.__shouldAlignStartVertically(e);this.style.justifyContent=o?"flex-start":"flex-end";const n=this.__isRTL,i=this.__shouldAlignStartHorizontally(e,n),s=!n&&i||n&&!i;this.style.alignItems=s?"flex-start":"flex-end";const r=this.getBoundingClientRect(),l=this.__calculatePositionInOneDimension(e,r,this.noVerticalOverlap,go,this,o),a=this.__calculatePositionInOneDimension(e,r,this.noHorizontalOverlap,yo,this,i);Object.assign(this.style,l,a),this.toggleAttribute("bottom-aligned",!o),this.toggleAttribute("top-aligned",o),this.toggleAttribute("end-aligned",!s),this.toggleAttribute("start-aligned",s)}__shouldAlignStartHorizontally(e,o){const n=Math.max(this.__oldContentWidth||0,this.$.overlay.offsetWidth);this.__oldContentWidth=this.$.overlay.offsetWidth;const i=Math.min(window.innerWidth,document.documentElement.clientWidth),s=!o&&this.horizontalAlign==="start"||o&&this.horizontalAlign==="end";return this.__shouldAlignStart(e,n,i,this.__margins,s,this.noHorizontalOverlap,yo)}__shouldAlignStartVertically(e){const o=this.requiredVerticalSpace||Math.max(this.__oldContentHeight||0,this.$.overlay.offsetHeight);this.__oldContentHeight=this.$.overlay.offsetHeight;const n=Math.min(window.innerHeight,document.documentElement.clientHeight),i=this.verticalAlign==="top";return this.__shouldAlignStart(e,o,n,this.__margins,i,this.noVerticalOverlap,go)}__shouldAlignStart(e,o,n,i,s,r,l){const a=n-e[r?l.end:l.start]-i[l.end],d=e[r?l.start:l.end]-i[l.start],c=s?a:d,m=c>(s?d:a)||c>o;return s===m}__adjustBottomProperty(e,o,n){let i;if(e===o.end){if(o.end===go.end){const s=Math.min(window.innerHeight,document.documentElement.clientHeight);if(n>s&&this.__oldViewportHeight){const r=this.__oldViewportHeight-s;i=n-r}this.__oldViewportHeight=s}if(o.end===yo.end){const s=Math.min(window.innerWidth,document.documentElement.clientWidth);if(n>s&&this.__oldViewportWidth){const r=this.__oldViewportWidth-s;i=n-r}this.__oldViewportWidth=s}}return i}__calculatePositionInOneDimension(e,o,n,i,s,r){const l=r?i.start:i.end,a=r?i.end:i.start,d=parseFloat(s.style[l]||getComputedStyle(s)[l]),c=this.__adjustBottomProperty(l,i,d),m=o[r?i.start:i.end]-e[n===r?i.end:i.start],h=c?`${c}px`:`${d+m*(r?-1:1)}px`;return{[l]:h,[a]:""}}};var _a=Object.defineProperty,wa=Object.getOwnPropertyDescriptor,we=(t,e,o,n)=>{for(var i=n>1?void 0:n?wa(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&_a(e,o,i),i};class Sa extends CustomEvent{constructor(e){super("color-picker-change",{detail:{value:e}})}}const xi=E`
  :host {
    --preview-size: 24px;
...
`;let Qe=class extends A{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[xi,E`
    ...
    ></button>`}open(){this.commitValue=!1,this.overlay.opened=!0,this.overlay.style.zIndex="1000000";const t=this.overlay.shadowRoot.querySelector('[part="overlay"]');t.style.background="#333"}renderOverlayContent(t){const e=getComputedStyle(this.toggle,"::after").getPropertyValue("background-color");Ae(v` <div>
        ...
        ></vaadin-dev-tools-color-picker-overlay-content>
      </div>`,t)}handleColorChange(t){this.commitValue=!0,this.dispatchEvent(new Sa(t.detail.value)),t.detail.close&&(this.overlay.opened=!1,this.handleOverlayClose())}handleOverlayEscape(){this.commitValue=!1}handleOverlayClose(){const t=this.commitValue?"color-picker-commit":"color-picker-cancel";this.dispatchEvent(new CustomEvent(t))}};we([y({})],Qe.prototype,"value",2);we([y({})],Qe.prototype,"presets",2);we([tt("#toggle")],Qe.prototype,"toggle",2);Qe=we([F("vaadin-dev-tools-color-picker")],Qe);let At=class extends A{static get styles(){return[xi,E`
        :host {
          display: block;
          padding: 12px;
        }
      ...
      ></button>`);return v` <div class="swatches">${t}</div>`}handlePickerChange(t){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:t.detail.value}}))}selectPreset(t){this.dispatchEvent(new CustomEvent("color-changed",{detail:{value:t,close:!0}}))}};we([y({})],At.prototype,"value",2);we([y({})],At.prototype,"presets",2);At=we([F("vaadin-dev-tools-color-picker-overlay-content")],At);customElements.whenDefined("vaadin-overlay").then(()=>{const t=customElements.get("vaadin-overlay");class e extends ba(t){}customElements.define("vaadin-dev-tools-color-picker-overlay",e)});customElements.define("vaadin-dev-tools-rgba-string-color-picker",ga);var xa=Object.defineProperty,Ea=Object.getOwnPropertyDescriptor,Ca=(t,e,o,n)=>{for(var i=n>1?void 0:n?Ea(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&xa(e,o,i),i};let Bn=class extends q{constructor(){super(...arguments),this.presets=new kt}static get styles(){return[q.styles,E`
        .editor-row {
          align-items: center;
        }
      ...
      `]}update(t){t.has("propertyMetadata")&&(this.presets=new kt(this.propertyMetadata)),super.update(t)}renderEditor(){var t;return v`
      ...
      <vaadin-dev-tools-theme-text-input
        ...
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}handleInputChange(t){this.value=t.detail.value,this.dispatchChange(this.value)}handleColorPickerChange(t){this.value=t.detail.value}handleColorPickerCommit(){this.dispatchChange(this.value)}handleColorPickerCancel(){this.updateValueFromTheme()}dispatchChange(t){const e=this.presets.tryMapToPreset(t);super.dispatchChange(e)}updateValueFromTheme(){var t;super.updateValueFromTheme(),this.value=this.presets.tryMapToRawValue(((t=this.propertyValue)==null?void 0:t.value)||"")}};Bn=Ca([F("vaadin-dev-tools-theme-color-property-editor")],Bn);var ka=Object.defineProperty,$a=Object.getOwnPropertyDescriptor,jo=(t,e,o,n)=>{for(var i=n>1?void 0:n?$a(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&ka(e,o,i),i};class Ta extends CustomEvent{constructor(e){super("open-css",{detail:{element:e}})}}let It=class extends A{static get styles(){return E`
      .section .header {
        display: flex;
        align-items: baseline;
    ...
    `}handleOpenCss(t){this.dispatchEvent(new Ta(t))}renderPropertyEditor(t,e){let o;switch(e.editorType){case P.checkbox:o=ct`vaadin-dev-tools-theme-checkbox-property-editor`;break;case P.range:o=ct`vaadin-dev-tools-theme-range-property-editor`;break;case P.color:o=ct`vaadin-dev-tools-theme-color-property-editor`;break;default:o=ct`vaadin-dev-tools-theme-text-property-editor`}return mr` <${o}
        ...
        >
        </${o}>`}};jo([y({})],It.prototype,"metadata",2);jo([y({})],It.prototype,"theme",2);It=jo([F("vaadin-dev-tools-theme-property-list")],It);var Na=Object.defineProperty,Pa=Object.getOwnPropertyDescriptor,Aa=(t,e,o,n)=>{for(var i=n>1?void 0:n?Pa(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&Na(e,o,i),i};let Rt=class extends A{render(){return v`<div
      tabindex="-1"
      @mousemove=${this.onMouseMove}
      @click=${this.onClick}
      @keydown=${this.onKeyDown}
    ></div>`}onClick(t){const e=this.getTargetElement(t);this.dispatchEvent(new CustomEvent("shim-click",{detail:{target:e}}))}onMouseMove(t){const e=this.getTargetElement(t);this.dispatchEvent(new CustomEvent("shim-mousemove",{detail:{target:e}}))}onKeyDown(t){this.dispatchEvent(new CustomEvent("shim-keydown",{detail:{originalEvent:t}}))}getTargetElement(t){this.style.display="none";const e=document.elementFromPoint(t.clientX,t.clientY);return this.style.display="",e}};Rt.shadowRootOptions={...A.shadowRootOptions,delegatesFocus:!0};Rt.styles=[E`
      div {
        pointer-events: auto;
...
`;var Ia=Object.defineProperty,Ra=Object.getOwnPropertyDescriptor,ot=(t,e,o,n)=>{for(var i=n>1?void 0:n?Ra(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&Ia(e,o,i),i};let he=class extends A{constructor(){super(...arguments),this.active=!1,this.components=[],this.selected=0}connectedCallback(){super.connectedCallback();const t=new CSSStyleSheet;t.replaceSync(`
    ...
    `];ot([T()],he.prototype,"active",2);ot([T()],he.prototype,"components",2);ot([T()],he.prototype,"selected",2);ot([tt("vaadin-dev-tools-shim")],he.prototype,"shim",2);he=ot([F("vaadin-dev-tools-component-picker")],he);const Oa=Object.freeze(Object.defineProperty({__proto__:null,get ComponentPicker(){return he}},Symbol.toStringTag,{value:"Module"}));var La=Object.defineProperty,Ma=Object.getOwnPropertyDescriptor,pe=(t,e,o,n)=>{for(var i=n>1?void 0:n?Ma(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&La(e,o,i),i};Vo(E`
...
`);let ie=class extends A{constructor(){super(...arguments),this.expanded=!1,this.themeEditorState=Ye.enabled,this.context=null,this.baseTheme=null,this.editedTheme=null,this.effectiveTheme=null}static get styles(){return E`
    ...
    >
      ...
      `,pickCallback:async e=>{var o;const n=await Tr.getMetadata(e);if(!n){this.context={component:e,scope:((o=this.context)==null?void 0:o.scope)||z.local},this.baseTheme=null,this.editedTheme=null,this.effectiveTheme=null;return}this.highlightElement(e.element),this.refreshComponentAndTheme(e,n)}})}handleScopeChange(t){this.context&&this.refreshTheme({...this.context,scope:t.detail.value})}async handlePropertyChange(t){if(!this.context||!this.baseTheme||!this.editedTheme)return;const{element:e,property:o,value:n}=t.detail;this.editedTheme.updatePropertyValue(e.selector,o.propertyName,n,!0),this.effectiveTheme=ce.combine(this.baseTheme,this.editedTheme),await this.ensureLocalClassName();const i={themeScope:this.context.scope,localClassName:this.context.localClassName},s=Nr(e,i,o.propertyName,n);try{const r=await this.api.setCssRules([s]);this.historyActions=this.history.push(r.requestId);const l=Pr(s);fe.add(l)}catch(r){console.error("Failed to update property value",r)}}async handleUndo(){this.historyActions=await this.history.undo(),await this.refreshComponentAndTheme()}async handleRedo(){this.historyActions=await this.history.redo(),await this.refreshComponentAndTheme()}async ensureLocalClassName(){if(!this.context||this.context.scope===z.global||this.context.localClassName)return;if(!this.context.localClassName&&!this.context.suggestedClassName)throw new Error("Cannot assign local class name for the component because it does not have a suggested class name");const t=this.context.component.element,e=this.context.suggestedClassName;this.context.localClassName=e;const o=await this.api.setLocalClassName(this.context.component,e);this.historyActions=this.history.push(o.requestId,()=>fe.previewLocalClassName(t,e),()=>fe.previewLocalClassName(t))}async refreshComponentAndTheme(t,e){var o,n,i;if(t=t||((o=this.context)==null?void 0:o.component),e=e||((n=this.context)==null?void 0:n.metadata),!t||!e)return;const s=await this.api.loadComponentMetadata(t);fe.previewLocalClassName(t.element,s.className),await this.refreshTheme({scope:((i=this.context)==null?void 0:i.scope)||z.local,metadata:e,component:t,localClassName:s.className,suggestedClassName:s.suggestedClassName,accessible:s.accessible})}async refreshTheme(t){const e=t||this.context;if(!e||!e.metadata)return;if(e.scope===z.local&&!e.accessible){this.context=e,this.baseTheme=null,this.editedTheme=null,this.effectiveTheme=null;return}let o=new ce(e.metadata);if(!(e.scope===z.local&&!e.localClassName)){const i={themeScope:e.scope,localClassName:e.localClassName},s=e.metadata.elements.map(l=>Le(l,i)),r=await this.api.loadRules(s);o=ce.fromServerRules(e.metadata,i,r.rules)}const n=await Ar(e.metadata);this.context=e,this.baseTheme=n,this.editedTheme=o,this.effectiveTheme=ce.combine(n,this.editedTheme)}highlightElement(t){t&&t.classList.add("vaadin-theme-editor-highlight")}removeElementHighlight(t){t&&t.classList.remove("vaadin-theme-editor-highlight")}};pe([y({})],ie.prototype,"expanded",2);pe([y({})],ie.prototype,"themeEditorState",2);pe([y({})],ie.prototype,"pickerProvider",2);pe([y({})],ie.prototype,"connection",2);pe([T()],ie.prototype,"historyActions",2);pe([T()],ie.prototype,"context",2);pe([T()],ie.prototype,"effectiveTheme",2);ie=pe([F("vaadin-dev-tools-theme-editor")],ie);var Va=function(){var t=document.getSelection();if(!t.rangeCount)return function(){};for(var e=document.activeElement,o=[],n=0;n<t.rangeCount;n++)o.push(t.getRangeAt(n));switch(e.tagName.toUpperCase()){case"INPUT":case"TEXTAREA":e.blur();break;default:e=null;break}return t.removeAllRanges(),function(){t.type==="Caret"&&t.removeAllRanges(),t.rangeCount||o.forEach(function(i){t.addRange(i)}),e&&e.focus()}},Hn={"text/plain":"Text","text/html":"Url",default:"Text"},Da="Copy to clipboard: #{key}, Enter";function za(t){var e=(/mac os x/i.test(navigator.userAgent)?"⌘":"Ctrl")+"+C";return t.replace(/#{\s*key\s*}/g,e)}function Ua(t,e){var o,n,i,s,r,l,a=!1;e||(e={}),o=e.debug||!1;try{i=Va(),s=document.createRange(),r=document.getSelection(),l=document.createElement("span"),l.textContent=t,l.style.all="unset",l.style.position="fixed",l.style.top=0,l.style.clip="rect(0, 0, 0, 0)",l.style.whiteSpace="pre",l.style.webkitUserSelect="text",l.style.MozUserSelect="text",l.style.msUserSelect="text",l.style.userSelect="text",l.addEventListener("copy",function(c){if(c.stopPropagation(),e.format)if(c.preventDefault(),typeof c.clipboardData>"u"){o&&console.warn("unable to use e.clipboardData"),o&&console.warn("trying IE specific stuff"),window.clipboardData.clearData();var m=Hn[e.format]||Hn.default;window.clipboardData.setData(m,t)}else c.clipboardData.clearData(),c.clipboardData.setData(e.format,t);e.onCopy&&(c.preventDefault(),e.onCopy(c.clipboardData))}),document.body.appendChild(l),s.selectNodeContents(l),r.addRange(s);var d=document.execCommand("copy");if(!d)throw new Error("copy command was unsuccessful");a=!0}catch(c){o&&console.error("unable to copy using execCommand: ",c),o&&console.warn("trying IE specific stuff");try{window.clipboardData.setData(e.format||"text",t),e.onCopy&&e.onCopy(window.clipboardData),a=!0}catch(m){o&&console.error("unable to copy using clipboardData: ",m),o&&console.error("falling back to prompt"),n=za("message"in e?e.message:Da),window.prompt(n,t)}}finally{r&&(typeof r.removeRange=="function"?r.removeRange(s):r.removeAllRanges()),l&&document.body.removeChild(l),i()}return a}const Fo=1e3,Bo=(t,e)=>{const o=Array.from(t.querySelectorAll(e.join(", "))),n=Array.from(t.querySelectorAll("*")).filter(i=>i.shadowRoot).flatMap(i=>Bo(i.shadowRoot,e));return[...o,...n]};let qn=!1;const Ze=(t,e)=>{qn||(window.addEventListener("message",i=>{i.data==="validate-license"&&window.location.reload()},!1),qn=!0);const o=t._overlayElement;if(o){if(o.shadowRoot){const i=o.shadowRoot.querySelector("slot:not([name])");if(i&&i.assignedElements().length>0){Ze(i.assignedElements()[0],e);return}}Ze(o,e);return}const n=e.messageHtml?e.messageHtml:`${e.message} <p>Component: ${e.product.name} ${e.product.version}</p>`.replace(/https:([^ ]*)/g,"<a href='https:$1'>https:$1</a>");t.isConnected&&(t.outerHTML=`<no-license style="display:flex;align-items:center;text-align:center;justify-content:center;"><div>${n}</div></no-license>`)},Be={},Wn={},Ve={},Ci={},Q=t=>`${t.name}_${t.version}`,Gn=t=>{const{cvdlName:e,version:o}=t.constructor,n={name:e,version:o},i=t.tagName.toLowerCase();Be[e]=Be[e]??[],Be[e].push(i);const s=Ve[Q(n)];s&&setTimeout(()=>Ze(t,s),Fo),Ve[Q(n)]||Ci[Q(n)]||Wn[Q(n)]||(Wn[Q(n)]=!0,window.Vaadin.devTools.checkLicense(n))},ja=t=>{Ci[Q(t)]=!0,console.debug("License check ok for",t)},ki=t=>{const e=t.product.name;Ve[Q(t.product)]=t,console.error("License check failed for",e);const o=Be[e];(o==null?void 0:o.length)>0&&Bo(document,o).forEach(n=>{setTimeout(()=>Ze(n,Ve[Q(t.product)]),Fo)})},Fa=t=>{const e=t.message,o=t.product.name;t.messageHtml=`No license found. <a target=_blank onclick="javascript:window.open(this.href);return false;" href="${e}">Go here to start a trial or retrieve your license.</a>`,Ve[Q(t.product)]=t,console.error("No license found when checking",o);const n=Be[o];(n==null?void 0:n.length)>0&&Bo(document,n).forEach(i=>{setTimeout(()=>Ze(i,Ve[Q(t.product)]),Fo)})},Ba=()=>{window.Vaadin.devTools.createdCvdlElements.forEach(t=>{Gn(t)}),window.Vaadin.devTools.createdCvdlElements={push:t=>{Gn(t)}}};var M=(t=>(t.ACTIVE="active",t.INACTIVE="inactive",t.UNAVAILABLE="unavailable",t.ERROR="error",t))(M||{});const $i=class Ti extends Object{constructor(e){super(),this.status="unavailable",e&&(this.webSocket=new WebSocket(e),this.webSocket.onmessage=o=>this.handleMessage(o),this.webSocket.onerror=o=>this.handleError(o),this.webSocket.onclose=o=>{this.status!=="error"&&this.setStatus("unavailable"),this.webSocket=void 0}),setInterval(()=>{this.webSocket&&self.status!=="error"&&this.status!=="unavailable"&&this.webSocket.send("")},Ti.HEARTBEAT_INTERVAL)}onHandshake(){}onReload(){}onUpdate(e,o){}onConnectionError(e){}onStatusChange(e){}onMessage(e){console.error("Unknown message received from the live reload server:",e)}handleMessage(e){let o;try{o=JSON.parse(e.data)}catch(n){this.handleError(`[${n.name}: ${n.message}`);return}o.command==="hello"?(this.setStatus("active"),this.onHandshake()):o.command==="reload"?this.status==="active"&&this.onReload():o.command==="update"?this.status==="active"&&this.onUpdate(o.path,o.content):o.command==="license-check-ok"?ja(o.data):o.command==="license-check-failed"?ki(o.data):o.command==="license-check-nokey"?Fa(o.data):this.onMessage(o)}handleError(e){console.error(e),this.setStatus("error"),e instanceof Event&&this.webSocket?this.onConnectionError(`Error in WebSocket connection to ${this.webSocket.url}`):this.onConnectionError(e)}setActive(e){!e&&this.status==="active"?this.setStatus("inactive"):e&&this.status==="inactive"&&this.setStatus("active")}setStatus(e){this.status!==e&&(this.status=e,this.onStatusChange(e))}send(e,o){const n=JSON.stringify({command:e,data:o});this.webSocket?this.webSocket.readyState!==WebSocket.OPEN?this.webSocket.addEventListener("open",()=>this.webSocket.send(n)):this.webSocket.send(n):console.error(`Unable to send message ${e}. No websocket is available`)}setFeature(e,o){this.send("setFeature",{featureId:e,enabled:o})}sendTelemetry(e){this.send("reportTelemetry",{browserData:e})}sendLicenseCheck(e){this.send("checkLicense",e)}sendShowComponentCreateLocation(e){this.send("showComponentCreateLocation",e)}sendShowComponentAttachLocation(e){this.send("showComponentAttachLocation",e)}};$i.HEARTBEAT_INTERVAL=18e4;let bo=$i;var Ha=Object.defineProperty,qa=Object.getOwnPropertyDescriptor,N=(t,e,o,n)=>{for(var i=n>1?void 0:n?qa(e,o):e,s=t.length-1,r;s>=0;s--)(r=t[s])&&(i=(n?r(e,o,i):r(i))||i);return n&&i&&Ha(e,o,i),i},_;const k=(_=class extends A{constructor(){super(),this.expanded=!1,this.messages=[],this.notifications=[],this.frontendStatus=M.UNAVAILABLE,this.javaStatus=M.UNAVAILABLE,this.tabs=[{id:"log",title:"Log",render:()=>this.renderLog(),activate:this.activateLog},{id:"info",title:"Info",render:()=>this.renderInfo()},{id:"features",title:"Feature Flags",render:()=>this.renderFeatures()}],this.activeTab="log",this.serverInfo={flowVersion:"",vaadinVersion:"",javaVersion:"",osVersion:"",productName:""},this.features=[],this.unreadErrors=!1,this.componentPickActive=!1,this.themeEditorState=Ye.disabled,this.nextMessageId=1,this.transitionDuration=0,this.disableLiveReloadTimeout=null,window.Vaadin.Flow&&this.tabs.push({id:"code",title:"Code",render:()=>this.renderCode()})}static get styles(){return[E`
        :host {
      ...
      `,Ei]}static get isActive(){const t=window.sessionStorage.getItem(_.ACTIVE_KEY_IN_SESSION_STORAGE);return t===null||t!=="false"}static notificationDismissed(t){const e=window.localStorage.getItem(_.DISMISSED_NOTIFICATIONS_IN_LOCAL_STORAGE);return e!==null&&e.includes(t)}elementTelemetry(){let t={};try{const e=localStorage.getItem("vaadin.statistics.basket");if(!e)return;t=JSON.parse(e)}catch{return}this.frontendConnection&&this.frontendConnection.sendTelemetry(t)}openWebSocketConnection(){this.frontendStatus=M.UNAVAILABLE,this.javaStatus=M.UNAVAILABLE;const t=l=>this.log("error",l),e=()=>{this.showSplashMessage("Reloading…");const l=window.sessionStorage.getItem(_.TRIGGERED_COUNT_KEY_IN_SESSION_STORAGE),a=l?parseInt(l,10)+1:1;window.sessionStorage.setItem(_.TRIGGERED_COUNT_KEY_IN_SESSION_STORAGE,a.toString()),window.sessionStorage.setItem(_.TRIGGERED_KEY_IN_SESSION_STORAGE,"true"),window.location.reload()},o=(l,a)=>{let d=document.head.querySelector(`style[data-file-path='${l}']`);d?(this.log("information","Hot update of "+l),d.textContent=a,document.dispatchEvent(new CustomEvent("vaadin-theme-updated"))):e()},n=new bo(this.getDedicatedWebSocketUrl());n.onHandshake=()=>{this.log("log","Vaadin development mode initialized"),_.isActive||n.setActive(!1),this.elementTelemetry()},n.onConnectionError=t,n.onReload=e,n.onUpdate=o,n.onStatusChange=l=>{this.frontendStatus=l},n.onMessage=l=>this.handleFrontendMessage(l),this.frontendConnection=n;let i;this.backend===_.SPRING_BOOT_DEVTOOLS&&this.springBootLiveReloadPort?(i=new bo(this.getSpringBootWebSocketUrl(window.location)),i.onHandshake=()=>{_.isActive||i.setActive(!1)},i.onReload=e,i.onConnectionError=t):this.backend===_.JREBEL||this.backend===_.HOTSWAP_AGENT?i=n:i=new bo(void 0);const s=i.onStatusChange;i.onStatusChange=l=>{s(l),this.javaStatus=l};const r=i.onHandshake;i.onHandshake=()=>{r(),this.backend&&this.log("information",`Java live reload available: ${_.BACKEND_DISPLAY_NAME[this.backend]}`)},this.javaConnection=i,this.backend||this.showNotification("warning","Java live reload unavailable","Live reload for Java changes is currently not set up. Find out how to make use of this functionality to boost your workflow.","https://vaadin.com/docs/latest/flow/configuration/live-reload","liveReloadUnavailable")}handleFrontendMessage(t){if((t==null?void 0:t.command)==="serverInfo")this.serverInfo=t.data;else if((t==null?void 0:t.command)==="featureFlags")this.features=t.data.features;else if((t==null?void 0:t.command)==="themeEditorState"){const e=!!window.Vaadin.Flow;this.themeEditorState=t.data,e&&this.themeEditorState!==Ye.disabled&&(this.tabs.push({id:"theme-editor",title:"Theme Editor (Preview)",render:()=>this.renderThemeEditor()}),this.requestUpdate())}else console.error("Unknown message from front-end connection:",JSON.stringify(t))}getDedicatedWebSocketUrl(){function t(o){const n=document.createElement("div");return n.innerHTML=`<a href="${o}"/>`,n.firstChild.href}if(this.url===void 0)return;const e=t(this.url);if(!e.startsWith("http://")&&!e.startsWith("https://")){console.error("The protocol of the url should be http or https for live reload to work.");return}return`${e.replace(/^http/,"ws")}?v-r=push&debug_window`}getSpringBootWebSocketUrl(t){const{hostname:e}=t,o=t.protocol==="https:"?"wss":"ws";if(e.endsWith("gitpod.io")){const n=e.replace(/.*?-/,"");return`${o}://${this.springBootLiveReloadPort}-${n}`}else return`${o}://${e}:${this.springBootLiveReloadPort}`}connectedCallback(){if(super.connectedCallback(),this.catchErrors(),this.disableEventListener=e=>this.demoteSplashMessage(),document.body.addEventListener("focus",this.disableEventListener),document.body.addEventListener("click",this.disableEventListener),this.openWebSocketConnection(),window.sessionStorage.getItem(_.TRIGGERED_KEY_IN_SESSION_STORAGE)){const e=new Date,o=`${`0${e.getHours()}`.slice(-2)}:${`0${e.getMinutes()}`.slice(-2)}:${`0${e.getSeconds()}`.slice(-2)}`;this.showSplashMessage(`Page reloaded at ${o}`),window.sessionStorage.removeItem(_.TRIGGERED_KEY_IN_SESSION_STORAGE)}this.transitionDuration=parseInt(window.getComputedStyle(this).getPropertyValue("--dev-tools-transition-duration"),10);const t=window;t.Vaadin=t.Vaadin||{},t.Vaadin.devTools=Object.assign(this,t.Vaadin.devTools),Ba(),document.documentElement.addEventListener("vaadin-overlay-outside-click",e=>{const o=e,n=o.target.owner;n&&br(this,n)||o.detail.sourceEvent.composedPath().includes(this)&&e.preventDefault()})}format(t){return t.toString()}catchErrors(){const t=window.Vaadin.ConsoleErrors;t&&t.forEach(e=>{this.log("error",e.map(o=>this.format(o)).join(" "))}),window.Vaadin.ConsoleErrors={push:e=>{this.log("error",e.map(o=>this.format(o)).join(" "))}}}disconnectedCallback(){this.disableEventListener&&(document.body.removeEventListener("focus",this.disableEventListener),document.body.removeEventListener("click",this.disableEventListener)),super.disconnectedCallback()}toggleExpanded(){this.notifications.slice().forEach(t=>this.dismissNotification(t.id)),this.expanded=!this.expanded,this.expanded&&this.root.focus()}showSplashMessage(t){this.splashMessage=t,this.splashMessage&&(this.expanded?this.demoteSplashMessage():setTimeout(()=>{this.demoteSplashMessage()},_.AUTO_DEMOTE_NOTIFICATION_DELAY))}demoteSplashMessage(){this.splashMessage&&this.log("log",this.splashMessage),this.showSplashMessage(void 0)}checkLicense(t){this.frontendConnection?this.frontendConnection.sendLicenseCheck(t):ki({message:"Internal error: no connection",product:t})}log(t,e,o,n){const i=this.nextMessageId;for(this.nextMessageId+=1,this.messages.push({id:i,type:t,message:e,details:o,link:n,dontShowAgain:!1,deleted:!1});this.messages.length>_.MAX_LOG_ROWS;)this.messages.shift();this.requestUpdate(),this.updateComplete.then(()=>{const s=this.renderRoot.querySelector(".message-tray .message:last-child");this.expanded&&s?(setTimeout(()=>s.scrollIntoView({behavior:"smooth"}),this.transitionDuration),this.unreadErrors=!1):t==="error"&&(this.unreadErrors=!0)})}showNotification(t,e,o,n,i){if(i===void 0||!_.notificationDismissed(i)){if(this.notifications.filter(r=>r.persistentId===i).filter(r=>!r.deleted).length>0)return;const s=this.nextMessageId;this.nextMessageId+=1,this.notifications.push({id:s,type:t,message:e,details:o,link:n,persistentId:i,dontShowAgain:!1,deleted:!1}),n===void 0&&setTimeout(()=>{this.dismissNotification(s)},_.AUTO_DEMOTE_NOTIFICATION_DELAY),this.requestUpdate()}else this.log(t,e,o,n)}dismissNotification(t){const e=this.findNotificationIndex(t);if(e!==-1&&!this.notifications[e].deleted){const o=this.notifications[e];if(o.dontShowAgain&&o.persistentId&&!_.notificationDismissed(o.persistentId)){let n=window.localStorage.getItem(_.DISMISSED_NOTIFICATIONS_IN_LOCAL_STORAGE);n=n===null?o.persistentId:`${n},${o.persistentId}`,window.localStorage.setItem(_.DISMISSED_NOTIFICATIONS_IN_LOCAL_STORAGE,n)}o.deleted=!0,this.log(o.type,o.message,o.details,o.link),setTimeout(()=>{const n=this.findNotificationIndex(t);n!==-1&&(this.notifications.splice(n,1),this.requestUpdate())},this.transitionDuration)}}findNotificationIndex(t){let e=-1;return this.notifications.some((o,n)=>o.id===t?(e=n,!0):!1),e}toggleDontShowAgain(t){const e=this.findNotificationIndex(t);if(e!==-1&&!this.notifications[e].deleted){const o=this.notifications[e];o.dontShowAgain=!o.dontShowAgain,this.requestUpdate()}}setActive(t){var e,o;(e=this.frontendConnection)==null||e.setActive(t),(o=this.javaConnection)==null||o.setActive(t),window.sessionStorage.setItem(_.ACTIVE_KEY_IN_SESSION_STORAGE,t?"true":"false")}getStatusColor(t){return t===M.ACTIVE?"var(--dev-tools-green-color)":t===M.INACTIVE?"var(--dev-tools-grey-color)":t===M.UNAVAILABLE?"var(--dev-tools-yellow-hsl)":t===M.ERROR?"var(--dev-tools-red-color)":"none"}renderMessage(t){return v`
      <div
    ...
    `}render(){return v` <div
      ...
      >
        ...
        ></span>
        ${this.splashMessage?v`<span class="status-description">${this.splashMessage}</span></div>`:C}
 ...
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Ni=[];function Pi(t){return t&&Object.prototype.hasOwnProperty.call(t,"__themes")}function il(t){return Pi(customElements.get(t))}function sl(t=[]){return[t].flat(1/0).filter(e=>e instanceof Io?!0:(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1))}function Ai(t,e,o={}){t&&il(t)&&console.warn(`The custom element definition for "${t}"
      was finalized before a style module was registered.
      Make sure to add component specific style modules before
      importing the corresponding custom element.`),e=sl(e),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(t,e,o):Ni.push({themeFor:t,styles:e,include:o.include,moduleId:o.moduleId})}function To(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():Ni}function rl(t,e){return(t||"").split(" ").some(o=>new RegExp(`^${o.split("*").join(".*")}$`,"u").test(e))}function al(t=""){let e=0;return t.startsWith("lumo-")||t.startsWith("material-")?e=1:t.startsWith("vaadin-")&&(e=2),e}function Ii(t){const e=[];return t.include&&[].concat(t.include).forEach(o=>{const n=To().find(i=>i.moduleId===o);n?e.push(...Ii(n),...n.styles):console.warn(`Included moduleId ${o} not found in style registry`)},t.styles),e}function ll(t,e){const o=document.createElement("style");o.innerHTML=t.map(n=>n.cssText).join(`
`),e.content.appendChild(o)}function dl(t){const e=`${t}-default-theme`,o=To().filter(n=>n.moduleId!==e&&rl(n.themeFor,t)).map(n=>({...n,styles:[...Ii(n),...n.styles],includePriority:al(n.moduleId)})).sort((n,i)=>i.includePriority-n.includePriority);return o.length>0?o:To().filter(n=>n.moduleId===e)}const yl=t=>class extends nl(t){static finalize(){if(super.finalize(),this.elementStyles)return;const o=this.prototype._template;!o||Pi(this)||ll(this.getStylesForThis(),o)}static finalizeStyles(o){const n=this.getStylesForThis();return o?[...super.finalizeStyles(o),...n]:n}static getStylesForThis(){const o=Object.getPrototypeOf(this.prototype),n=(o?o.constructor.__themes:[])||[];this.__themes=[...n,...dl(this.is)];const i=this.__themes.flatMap(s=>s.styles);return i.filter((s,r)=>r===i.lastIndexOf(s))}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const cl=(t,...e)=>{const o=document.createElement("style");o.id=t,o.textContent=e.map(n=>n.toString()).join(`
`).replace(":host","html"),document.head.insertAdjacentElement("afterbegin",o)},Dt=(t,...e)=>{cl(`lumo-${t}`,e)};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const hl=E`
...
`;Dt("typography",pl,!1);const ml=t=>{const e=[];t!==document&&(e.push(Kn(Ho.cssText,"",t,!0)),e.push(Kn(qo.cssText,"",t,!0)))},fl=ml;fl(document);export{sr as D,je as F,A as L,nr as P,yl as T,Ne as U,x as _,Dt as a,be as b,E as c,ir as d,Ai as e,nl as f,Ho as g,v as h,qo as i,J as j,Sr as k,xr as l,C as n,Ae as r,Te as s,Ni as t,li as u,P as y};
